...
<?php    
	  ...
	  $a1=mysql_query("select * from cat_periodical_t where p_id='$call_no1'");
      ...
      <div class="row">
      		...
      		<div class="widget stacked" >
				...
				<div class="widget-header" id="printButton">
					...
					<h3><?php  if($isbn != 0){echo"Book Information"; }
					else{echo"Periodical Information";}?></h3>
				</div> <!-- /widget-header -->
...
if($isbn != NULL){?>
 ...
 <tr><td>Edition</td>
 <td><?php echo"$edition"; ?></td></tr> <?php }else{?>
 <tr><td>Label</td>
 ...
 <tr><td>ISBN</td>
 <td> <?php echo"$isbn"; }else{?></td></tr>
 <tr><td>ISSN</td>
 <td> <?php echo"$issn"; }?></td></tr>
 <tr><td>Supplier</td>
 ...
 <p> Mrs. Mary Ann O. Taduran<br>Librarian</p>
    <p align="right">&nbsp;<?php if($isbn != 0){?> 
                      <a class="btn btn-mini" href="print_book.php?call_no=<?php echo"$call_no1"; ?>"
                   style="background:#CCCCCC"><?php } else {?>
                    <a class="btn btn-mini" href="print_periodical.php?call_no=<?php echo"$call_no1"; ?>"
                   style="background:#CCCCCC"><?php }?> 
