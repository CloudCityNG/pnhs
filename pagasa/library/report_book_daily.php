...
<!-- InstanceBeginEditable name="content" -->
  ...
  <!-- MAIN -->
   ...
   <div class="widget-content" >
          <table class="table table-striped table-bordered">
           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
              <thead>
                <tr>
                  <th width="60">&nbsp;&nbsp;&nbsp;Date</div></th>
                  <th width="80">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Picture</div></th>
                  <th width="100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title</div></th>
                  <th width="100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Author</div></th>
                  <th width="40">&nbsp;Qty.</div></th>
                   <th width="100px">Person in charge</div></th>
                 <th width="40">&nbsp;&nbsp;Edit</div></th>
                </tr>
              </thead>
              <tbody>
        <?php 
		...
		$qry1=mysql_query("SELECT * FROM cat_books_t JOIN cat_reading_material_t ON cat_books_t.book_id = cat_reading_material_t.call_no WHERE date_recorded >= '$from' AND date_recorded <= '$to'");
                     ...
                     <a class="btn btn-mini" data-toggle="modal" href="#add_image<?php echo $id;?>"><i class="icon-plus"></i>Add Image</a>
                       ...
                       <div class="modal fade hide" id="add_image<?php echo $id?>">
                          <div class="modal-header">
                            ...
                            <h3>ADD IMAGE for <?php echo $title1;?></h3>
                          
                          </div> 
                          <div class="modal-body">
                                                <form style="text-align:center" action="pix.php<?php echo "?id=$id"; ?>"  method="post"   enctype="multipart/form-data">
...
<td><div align='center'>
				  <a   class="submit" onClick="window.open('bookinfo.php?call_no=<?php 
                ...
                ?>
                 ...
                 <td align="center"><div align='center'><a class="submit btn btn-mini" onClick="window.open('edit_book.php?call_no=<?php 
		...
		$call_no=$a['book_id'];
		$id=$call_no;
		$qry1=mysql_query("SELECT * FROM `cat_reading_material_t` where call_no='$call_no'");
		...
		$date2=$b['date_recorded'];	
		$date1=date('M d Y', strtotime($date2));
		$title1=$b['title'];
		$subtitle1=$b['subtitle'];
		$a_id1=$b['author_id'];
		$img=$b['image'];
...
while($d=mysql_fetch_array($author)){
		$author1=$d['aut'];
			...
			$empl1=mysql_fetch_array(mysql_query("SELECT * FROM `employee_account_t` WHERE account_no='$charge'"));
			$emp_id=$empl1['emp_id'];
			$employee12=mysql_fetch_array(mysql_query("SELECT * FROM `employee_t` WHERE emp_id='$emp_id'"));
			$fname=$employee12['f_name'];
			$mname=$employee12['m_name'];
			$lname=$employee12['l_name'];}}
			echo"<tr>
                  <td><div align='center'>$date1</div></td>";
                 ?>                
                 <td><div align='center'><?php if($img!=NULL){ ?>
 				<a href="../library/book/<?php echo $img; ?>" class="ui-lightbox">
                     ...
                     <a class="btn btn-mini" data-toggle="modal" href="#add_image<?php echo $id;?>"><i class="icon-plus"></i>Add Image</a>
                       ...
                       <div class="modal fade hide" id="add_image<?php echo $id?>">
                          ...
                          <div class="modal-body">
                                                <form style="text-align:center" action="pix.php<?php echo "?id=$call_no"; ?>"  method="post"   enctype="multipart/form-data">
...
<td><div align='center'>
                  ...
                  <?php 
				  echo"<td><div align='center'>$author1 $author2 $author3</div></td>
                  <td><div align='center'>$copies</div></td>
				  <td><div align='center'>$fname $mname $lname </div></td>";
                ?>
		...
		$action="Book Records";?>
                  <a class="btn btn-block" href="print_range_book.php?action=<?php echo"$action"; ?>" style="background:#CCCCCC"> 
                 <img src="img/mono-icons/printer32.png" title="PRINT" width="40" height="40"><br>Print</a>
	<?php	}else{		

					?>
                  <a class="btn btn-block" href="print_range_book.php?from=<?php echo"$from"; ?>&&to=<?php echo"$to"; ?>&&action=<?php echo"$action"; ?>"
