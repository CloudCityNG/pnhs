	...
	<div class="container">
 	 <div class="">
      	<div class="span6">	
        		...
        		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <select style="width:200px;font-size:12px" name="year">
  				...
  				<div class="widget stacked widget-table">
					...
					<div class="widget-content">
						<table class="table table-bordered table-striped">
							...
							<thead width="10px"><tr>								
								<th>Call No</th>
								<th width="1000px"><div align="center">Reading Materials</div></th>								
							</tr></thead>
			...
			require "db.php";
							...
							if($year == 'School year')
							{
							echo"<p class='error-box'>Please select first</p>";
							}
							else if($year != NULL)
							{
$query=mysql_query("SELECT *,count(*) as total FROM cat_copies_t JOIN appraisal_t ON cat_copies_t.access_no = appraisal_t.access_no WHERE return_date >='$start1-06-01' and return_date <='$end1-03-30'  group by call_no order by total desc limit 10");
...
<a class="btn btn-mini" target="_blank" href="print_stat.php?year=<?php echo"$year";?>">
