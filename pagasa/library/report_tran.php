...
<!-- InstanceBeginEditable name="content" -->
      ...
      <div class="widget-content" >
        ...
        <div id="demo" style="min-height:400px;">
          <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="">
             ...
             <th  width="100">&nbsp;&nbsp;&nbsp;Retured Date</div></th>
	...
	<?php echo"<td><div align='center'>$fname1 $mname1 $lname1</div></td>";
             ?>
             </tr>
             <?php }}?>
            </tbody>
               ...
               <br><br>
                      <?php if($to==NULL){
				?>
                  <a class="btn btn-block" href="print_tran.php?action	=<?php echo"$action"; ?>" style="background:#CCCCCC"> 
                 <img src="img/mono-icons/printer32.png" title="PRINT" width="40" height="40"><br>Print</a>
	<?php	}else{		

					?>
                  <a class="btn btn-block" href="print_tran.php?from=<?php echo"$from"; ?>&&to=<?php echo"$to"; ?>&&action=<?php echo"$action"; ?>"
