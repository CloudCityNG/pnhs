...
?>		
            ...
            <li><a href="notification.php" ><i class="shortcut-icon icon-comment"></i><span class="shortcut-label">Notinifation&nbsp;<?php if($count >= 1){ echo"<font color='#00FF00'> ($count)";} else{}?></font></span></a></li>
	...
	include("livesearch.php");?>
						...
						<form  method="post" name="form1" id="searchform" action="#">
							<div>
			   <select style="width:auto; height:auto; background-color:#333333; border-color:#666666" id="text" type="select" name="category"   onBlur="clearInput(this)" >
                ...
                <option value="subject">SUBJECT</option>
            	    			...
            	    			<input type="text" placeholder="Search..." name="s" id="s"  onBlur="clearInput(this)" onKeyUp="showHint(this.value)" />
