      ...
      <div class="widget-content" >
        ...
        <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
             ...
             <th width="100" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Borrowed Date</div></th>
             <th width="100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Borrower's Name</th>
			...
			$book=mysql_query("SELECT * FROM `appraisal_t` WHERE  borrow_date >= '$from' AND borrow_date <= '$to' AND return_time = 0");
        ...
        <?php if($book1 == NULL){ ?>
			...
			echo "$title";?>&&herf=<?php echo"$herf"; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=900,position=center');"><?php echo $title2; ?> </a></div></td><?php 
			...
			$book=mysql_query("SELECT * FROM `appraisal_t` WHERE return_time = 0");
			while($a=mysql_fetch_array($book))
			{	
			$bdate=$a['borrow_date'];
			$btime=$a['borrow_time'];
             ...
             <?php }}?>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="balance.php"><i class="icon-user"></i>&nbsp;Credits</a>
                         <?php if($to==NULL){
				?>
                  <a class="btn btn-block" href="print_utran.php?action	=<?php echo"$action"; ?>" style="background:#CCCCCC"> 
                 <img src="img/mono-icons/printer32.png" title="PRINT" width="40" height="40"><br>Print</a>
	<?php	}else{		

					?>
                  <a class="btn btn-block" href="print_utran.php?from=<?php echo"$from"; ?>&&to=<?php echo"$to"; ?>&&action=<?php echo"$action"; ?>"
