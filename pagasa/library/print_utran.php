...
<h3 align="center" class="style16"> Unreturned Book(s) Record</h3>
...
<br />
 <div class="widget-content" >
		...
		{$call=$s_id;
			...
			echo"<tr><td><div align='center'>$title2</div</td>
			<td><div align='center'>$bdate1 &nbsp; $btime1</div</td>";
			echo"<td><div align='center'>$fname $mname $lname</div></td>";
            echo"<td><div align='center'>$fname1 $mname1 $lname1</div></td></tr>";
