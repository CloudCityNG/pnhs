...
<h1 align="center" class="style16">BOOK<br><br></h1>    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"  width="50%" align="center" style="font-size:17px">
<thead>
		<tr align="center">
							<th width="150px">
