...
@session_start();
		...
		$qry3=mysql_query("SELECT count(*) as count FROM `cat_periodical_t` WHERE p_id='$callno'");  
		...
		$qry5=mysql_query("SELECT * from cat_section_t where section_name='$section'");
		...
		$qry61=mysql_query("SELECT count(issn) as max from cat_periodical_t WHERE issn='$issn'");
		while($f1=mysql_fetch_array($qry61))		
		{
		$countisbn=$f1['max'];
		//$max1=$max+$copies;
		}
	...
	mysql_query("INSERT INTO `cat_reading_material_t` VALUES('$callno','$pages','$size','$unit','$title','$subtitle','$volume','$copyright','$daterecorded','$pu_id','$class','$section_no','')");
		...
		if($countbook=='0')
		{
			mysql_query("INSERT INTO `cat_periodical_t`VALUES ('$callno','$label','$month $year','$issn','$every $issueunit')");
			for($s=0; $s<$copies; $s++){
			$max=$max+000001;
			mysql_query("INSERT INTO `cat_copies_t`VALUES ('$max','$callno','On shelf','$account_no','$supplytype')");}
		}
		...
		<br><a onClick="window.close();" class="btn btn-success btn"><span class="icon i16-icon_bended-arrow-left"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DONE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
			<a href="periodical_add.php" class="btn"><span class="icon i16-icon_bended-arrow-right"></span>ADD MORE BOOKS</a>
					
</p>		
	<?php }else if($countrm != '0' && $countisbn == '0')
	{echo"<p class='error-box'> Call no. already exists</p>";}	
		else{
			$account_no=$_SESSION['account_no'];
			if($countrm != '0' && $countisbn != '0'){
				for($s=0; $s<$copies; $s++){
				$max=$max+000001;
				mysql_query("INSERT INTO `cat_copies_t`VALUES ('$max','$callno','On shelf','$account_no','$supplytype')");}
...
<?php	}}
		...
		?>
			...
			<td width="40"  colspan="8" style="background-color:#969696;font-size:23px; font-family:Georgia, 'Times New Roman', Times, serif"><strong>BOOK INFORMATION</strong></td>
             			...
             			<td>
                          ...
                          <tr><td>
                            ...
                            <div class="control-group ">
						      ...
						      <div class="controls">
						       <input  title="Enter Size"  type="text"  name="size" id="size" style="width:160px;height:20px;"/>
                    ...
                    <tr><td>
					<div class="control-group ">
					<label class="control-label" for="email">LABEL</label>
					<div class="controls">
                  <input  type="text"  name="label" id="fname"  style="width:250px;height:20px;" />
        			 </div></div>
					</td><td>
					<div class="control-group ">
					<label class="control-label" for="email">ISSN</label>
					<div class="controls">
                    <input    type="text" name="issn"  id="fname"  style="width:250px;height:20px;" /></div>
					</td></tr>
                    
                    <tr><td>
					<div class="control-group ">
					<label class="control-label" for="email">DATE OF ISSUE</label>
					<div class="controls">
                       <select name="month" class="selec3"  style="width:100px;font-size:12px">
			  ...
			  <select name="year" class="selec2" style="width:65px;font-size:12px">
				<?php
			   for($i=1900;$i<=date(Y);$i++)
			   {
				...
				<?php
						    ...
						    <div class="control-group ">
						      <label class="control-label" for="subject">CONTRACT COPIES</label>
						      <div class="controls">
                  <input  type="text"  name="quantity" id="fname"  style="width:250px;height:20px;" />
                       ...
                       <select name="publisher"  style="width:250px;font-size:12px">
						...
						<option value="<?php echo $numrow['pub_name'];?>"><?php echo $numrow['pub_name']?></option><?php
                         ...
                         <td>
                            <div class="control-group ">
						      <label class="control-label" for="subject">ISSUED WITHIN</label>
						      <div class="controls">
					    <input name="every"  type="text" name="quantity" id="fname"  style="width:150px;height:20px;"/>																			      			    <select name="issue_unit"  style="width:80px;font-size:12px" >
