      <?php	
					...
					mysql_query("UPDATE appraisal_t SET return_date='$return_date', return_time='$return_time', penalties ='$amount',fine='$fine', a_remark='paid' WHERE account_no='$account_no' and access_no='$access_no' and return_time='0'");
