...
@session_start();
	...
	mysql_query("UPDATE `cat_reading_material_t` SET pages='$pages1',size='$size1',unit='$unit1',title='$title1',subtitle='$subtitle1',volume='$volume1',copyright='$copyright1',publisher_id='$pu_id',subject='$class1',section_no='$section_no1' WHERE call_no='$call_no'");
		...
		mysql_query("UPDATE `cat_periodical_t` SET label='$label1',date_of_issue='$month1 $year1',issn='$issn1',issued_within='$every1 $issueunit1' WHERE p_id='$call_no'");
		}
		else
		{
		mysql_query("UPDATE `cat_periodical_t` SET label='$label1',issn='$issn1' WHERE p_id='$call_no'");
		}
	 	
		if($no != 0 && $copies > $copies1){echo"<br>All are been updated except for the quantity of periodical";}
		...
		echo"&nbsp;&nbsp;&nbsp;<b>Sucessfully Updated!!</b><br>";
			...
			?>
				<br>
                <a onClick="window.close();" class="btn btn-success btn"><span class="icon i16-icon_bended-arrow-left"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DONE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
				<?php
				echo"</p>";
    ...
    <option value="mm" <?php if($unit=='mm'){ ?>selected="selected"<?php } ?>>mm</option>
		 ...
		 <?php echo $ddc=mysql_query("SELECT * FROM cat_ddc_t");
					...
					<div class="controls">
                  <input  type="text"  name="label"  value="<?php echo"$label";?>" id="fname"  style="width:250px;height:20px;" />
        			 </div></div>
					</td><td>
					<div class="control-group ">
					<label class="control-label" for="email">ISSN</label>
					<div class="controls">
                    <input    type="text" value="<?php echo $issn;?>" name="issn"  id="fname"  style="width:250px;height:20px;" /></div>
					</td></tr>
        ...
        value='<?php echo"$dateofissue";?>' disabled="disabled"  />
                       <select name="month1" class="selec3"  style="width:100px;font-size:12px">
			  <option></option>
			  ...
			  <select name="year1" class="selec2" style="width:65px;font-size:12px">
				<option></option>
        ...
        value='<?php echo"$issued_within";?>' disabled="disabled"  />  
					 ...
					 <input name="every1"  type="text" name="quantity" id="fname"  style="width:150px;height:20px;"/>																			      			    <select name="issue_unit1"  style="width:80px;font-size:12px" >
					<option></option>
