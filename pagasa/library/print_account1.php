...
<h3 align="center" class="style16"><?php echo"$fname"; ?><br> Log Records</h3>
...
<?php 	
			if($to != NULL){
			$book=mysql_query("SELECT * FROM `appraisal_t` WHERE account_no='$id1' AND return_date >= '$from' AND return_date <= '$to'");
			...
			$rtime1=date('h:iA', strtotime($rtime));
