...
<!-- InstanceBeginEditable name="content" -->
      ...
      <div class="widget-content" >
		...
		{$call=$s_id;
			...
			echo"<tr>
				  ...
				  ?>
                   <?php if($book3 == NULL){ ?>
			<th><div align='center'>  <a   class="submit" onClick="window.open('periodicalinfo.php?call_no=<?php 
							echo "$call_no";?>&&herf=<?php echo"$herf"; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=900,position=center');"><?php echo $title; ?> </a></div></th>
			<?php }else{?>
            <th><div align='center'>  <a   class="submit" onClick="window.open('bookinfo.php?call_no=<?php 
			echo "$call_no";?>&&herf=<?php echo"$herf"; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=900,position=center');"><?php echo $title; ?> </a></div></th><?php }?>
		      	<th><div align='center'>
	...
	<?php 
		...
		echo"<th><div align='center'>Php. $amount</div></th>";
                ...
                <input type="submit" name="ren"	class="btn btn-mini" value="PAY">
				</form>
                </th>
</tr><?php 
	}
...
if($_POST['ren']){
				echo"<thead>
				<p class='warning-box' style='font-size:15px'>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Are you Sure Do you want to pay this account of $fname&nbsp;$mname&nbsp;$lname&nbsp;? <br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a class='btn btn-small' href='balance_paid.php?no=$no'>YES</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a class='btn btn-small' href='balance.php' >CANCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a class='btn btn-small href='balance.php'>NO</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		}}?>  
        </table>
               </div>
                </th>
               ...
               <br><br>
                      <?php if($to==NULL){
				?>
                  <a class="btn btn-block" href="print_credit.php?action	=<?php echo"$action"; ?>" style="background:#CCCCCC"> 
                 <img src="img/mono-icons/printer32.png" title="PRINT" width="40" height="40"><br>Print</a>
	<?php	}else{		

					?>
                  <a class="btn btn-block" href="print_credit.php?from=<?php echo"$from"; ?>&&to=<?php echo"$to"; ?>&&action=<?php echo"$action"; ?>"
