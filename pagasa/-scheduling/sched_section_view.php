...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    ...
    <div class="widget stacked widget-table action-table">
      ...
      <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content">
          ...
          <table style="width:100%" class="table table-bordered table-striped">
            ...
            <tr >
              <td>Year Level: </td>
			  <td><?php echo $row_section['year_level'];?> <br /></td>
            </tr>
            <tr >
              <td>Curriculum: </td>
      ...
      <!--</span>-->
      <div class="span4">
      <a class="btn btn-large btn-success" href="sched_section.php?section_id=<?php echo $_GET['section_id']?>&sy_id=<?php echo isset($_GET['sy_id'])? $_GET['sy_id']:get_active_sy();?>"><i class="icon-print"></i> PRINT </a>
      </div>
    <!-- InstanceEndEditable -->
