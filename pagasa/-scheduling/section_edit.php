...
$get_section_id = $_POST['section_id'];	
}

if(isset($_POST['update'])){
	$get_section_id = $_POST['section_id'];	
    $section_no = $_POST['e_section_no'];
	$year_level = $_POST['e_year_level'];
	$section_name = $_POST['e_section_name'];
	//$class_adviser = $_POST['class_adviser'];
	//$curriculum_code = $_POST['curriculum'];
	$curriculum_code = ($section_no==1)? "SEC":"K12";//$_POST['curriculum'];
	$class_size	 = $_POST['e_section_size'];
            ...
            <tbody>
              <tr >
                <th >
                    ...
                    <?php }?>
            <form name="edit_form" id="edit_form" action=""  class="" method="post" style="min-height:400px;">
