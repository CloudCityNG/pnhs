                ...
                <tbody>
                 ...
                 <?php 				     
                    ...
                    <tr class=" odd del<?php echo $section_id; ?>">
                      ...
                      <td align="center">
                          <a class='btn btn-mini' href='report_section_view.php?section_id=<?php echo $section_id;?>'> LOAD </a>
                          <a class='btn btn-mini' href='sched_section_view.php?section_id=<?php echo $section_id;?>'> SCHEDULE </a>
                      </td>
                    </tr>
