      ...
      <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-th-list"></i> List of Subjects per Year Level</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              <tr >
                        ...
                        <?php foreach($year_level_tabs as $lvl){?>
                            <div class="tab-pane <?php echo ($j==0)? "active":""; $j=1; ?>" id="<?php echo $lvl;?>">
                              <div id="demo" style="min-height:100px;">
                                ...
                                <p>&nbsp;</p>
                                <a href="report_print_subject.php?lvl_id=<?php echo $lvl;?>" class="btn btn-success pull-right"><i class="icon-print"></i> PRINT List for <?php echo ucfirst($row_lvl['lvl_name']);?></a>
                                <a target="_blank" href="pdf_list_subject.php?lvl_id=<?php echo $lvl;?>" class="btn pull-right"><i class="icon-print"></i> View PDF for <?php echo ucfirst($row_lvl['lvl_name']);?></a>
                              </div>
                            </div>
                        <?php }?>
                ...
                <div style=" ">
				  ...
				  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <a href="report_print_subject.php"  class="btn btn-large btn-block"><i class="icon-print"></i> PRINT ALL</a>
				</div>
                </th>
              </tr>
            </tbody>
