...
if(isset($_POST['add'])){
	...
	$curriculum_code = ($section_no==1)? "SSC":"K12";//$_POST['curriculum'];
	...
	if(is_numeric($section_no)){
	    if($section_name){
			if($class_size){
				$query = mysql_query("SELECT * FROM section_t WHERE section_name='$section_name'") ;
				if(mysql_num_rows($query)==0){
					$query2 = mysql_query("SELECT * FROM section_t WHERE section_no='$section_no' AND curriculum_code='$curriculum_code' AND year_level='$year_level'");
					if(mysql_num_rows($query2)==0){
						mysql_query("INSERT INTO section_t VALUES('$section_id', '$section_no', '$year_level', '$section_name', NULL, '$curriculum_code', '$class_size')")or die("NULL, '$section_no', '$year_level', '$section_name', NULL, '$curriculum_code', '$class_size') ".mysql_error());
...
<div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content" >
          ...
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-ambulance"></i> ADD SECTION</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
            ...
            <form name="add_section_form" id="add-form" action=""  class="" method="post" style="min-height:400px;" />
                <fieldset>
                <table class="container" style="width:auto;margin-top:50px;" >
                    ...
                    <tr>
                        <td></td>
                        <td><div class=" form-actions" align=""><input class="btn " type="submit" value="ADD" name="add" id="add"></div></td>
                    </tr>
