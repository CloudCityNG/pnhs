...
if(isset($_POST['update'])){
    ...
    if(is_numeric($room_no)){
		$query = mysql_query("SELECT * FROM class_room_t WHERE room_no='$room_no' AND room_no <> '$old_room_no'");
		if(mysql_num_rows($query)<1){
			$query2 = mysql_query("SELECT * FROM class_room_t WHERE section_assigned={$section_assigned} AND room_no <> '$old_room_no'");
			if(mysql_fetch_assoc($query2)<1){
				mysql_query("START TRANSACTION");
				mysql_query("UPDATE class_room_t SET room_no='$room_no', section_assigned='$section_assigned' WHERE room_no='$old_room_no'") or die("error in updating room. ");
				mysql_query("COMMIT;");
            ...
            <tbody>
              <tr >
                ...
                <th  >
                  <div id="error">
					<?php if(isset($msg)){?>
                    <?php if($msg=="successfully updated room."){?>
                ...
                <form name="update_room_form" class="form-horizontal" action="" method="post">
                    <table >
                        <tr>
                            <td> Room no :</td>
                        ...
                        <tr>
                            ...
                            <td><select  name="section_assigned" id="section_assigned">
                                    <option value="NULL" <?php if($section_assigned==NULL) echo "selected"; ?> >None</option>
                        ...
                        <tr></tr>
                        <tr>
                            <td><a href="room.php" class="btn">Back</a></td>
