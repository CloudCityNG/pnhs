    ...
    if($section){
        if(does_yr_level_match($section, $subject)){
			if( is_available($section, $subject, $teacher)){
				if(!$msg =is_teacher_max($teacher, $subject)){  //is_unit_maxed($lvl_id, 0, $subject_unit)
              ...
              <tr >
                ...
                <div id="demo" style="min-height:300px;">
                        ...
                        <tbody >
                         ...
                         <?php 				     
                            ...
                            <tr class="del<?php echo $class_id; ?>">
                              ...
                              <td>
                              <?php //echo $class_id." ";//$row['subject_code'];
                    ...
                    <?php 
					  ...
					  $whole1 = (int) $time;
					  $frac1 = (($time*100)%100)*.6;
					  printf("Total Time: %02d:%02d", $whole1, $frac1);
					?>
                </div>
                </th>
                <th >
            ...
            <form name="add_section_form" action=""  class="form-horizontal" method="post" style="min-height:400px;">
                <table class="container" style="width:auto;margin-top:50px;" >
                    ...
                    <tr>
                        ...
                        <?php
								require_once "../db/db.php";
								$query = mysql_query("SELECT * FROM teacher_t WHERE teacher_status=1");
								while($row = mysql_fetch_assoc($query)){
