                ...
                <div class="widget-content">
                  <table class="table table-striped table-bordered">
                    ...
                    <?php
					  ...
					  $query_curriculum = mysql_query("SELECT * FROM curriculum_t");
					  while($row_curriculum = mysql_fetch_assoc($query_curriculum)){ ?>
                      <tr>
                        <td><?php echo $row_curriculum['curriculum_code'];?></td>
                        <td><?php echo $row_curriculum['title'];?></td>
                        <th><a href="?curriculum_code=<?php echo $row_curriculum['curriculum_code'];?>" class="btn btn-mini">VIEW</a></th>
                      </tr>
					<?php  } ?>
                    </tbody>
                  </table>
      ...
      <!-- /wudget -->
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
              <?php $code=$_GET['curriculum_code']; ?>
                <th width="80%"><a href="curriculums.php" class="btn btn-mini"><i class=" icon-chevron-left"></i> back</a><i class="icon-list"></i> LIST OF SECTIONS -<?php echo $code; ?></th>
              </tr>
            </thead>
            <tbody>
              <tr >
          ...
          <table cellpadding="0" cellspacing="0" border="0" class=" " id="tab<?php echo $lvl;?>" width="100%">
              ...
              <tbody>
                 ...
                 <?php 
					...
					$query = mysql_query("SELECT * FROM section_t WHERE curriculum_code='$get_curriculum_code' AND year_level=$lvl");
