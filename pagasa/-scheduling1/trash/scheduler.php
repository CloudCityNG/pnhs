...
if(isset($_POST['add_load'])){
	...
	if(isset($_POST['day_menu'])){
		...
		$start_time = $times[$s_time_index].":00";
		$end_time = $times[$e_time_index].":00";
		
		if($class_id){ //$start_time<$end_time
			if(!$msg = is_faculty_loaded($class_id, $start_time, $end_time, $_POST['day_menu'])){ //!$msg = is_loaded()
				if(!$msg = is_section_loaded($_GET['section_id'], $start_time, $end_time, $_POST['day_menu'])){ //!$msg = is_teacher_max($emp_id, $subject_code)
                 ...
                 <?php 				     
                    ...
                    while($row = mysql_fetch_assoc($query)){
                      ...
                      <tr class="color<?php echo $i; ?>">
                        ...
                        <td><?php printf("%.2f/%.2f", total_hours($class_id), unit_to_time($units));?>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              -->
              <input type="text" disabled id="subject_area" value="<?php echo $class[0]['subject']?>"/>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              -->
              <input type="text"  disabled id="teacher_area" value="<?php echo $class[0]['teacher']?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td colspan="2">
                <div align="center">
                  ...
                  <label class="checkbox inline">
                    ...
                    Wed</label>
                  <label class="checkbox inline">
                    <input type="checkbox" name="day_menu[]" value="thursday" id="day_menu_3">
                    Thu</label>
                  <label class="checkbox inline">
...
<div class="modal fade hide" style="width:350px;;" id="edit_modal">
 							...
 							<form class="form-horizontal" name="edit_schedule" action="" method="post">
                              ...
                              <tr>
                                <td colspan="2">
                                    <div align="center">
                                      <label class="checkbox inline">
                                        <input type="checkbox" name="e_day_menu[]" value="monday" id="e_day_menu_0">
                                        Mon</label>
                                      <label class="checkbox inline">
                                        <input type="checkbox" name="e_day_menu[]" value="tuesday" id="e_day_menu_1">
                                        Tue</label>
                                      <label class="checkbox inline">
                                        <input type="checkbox" name="e_day_menu[]" value="wednesday" id="e_day_menu_2">
                                        Wed</label>
                                      <label class="checkbox inline">
                                        <input type="checkbox" name="e_day_menu[]" value="thursday" id="e_day_menu_3">
                                        Thu</label>
                                      <label class="checkbox inline">
                                        <input type="checkbox" name="e_day_menu[]" value="friday" id="e_day_menu_4">
                                        Fri</label>
                                    </div>
                                </td>
                              </tr>
  ...
  <div class="modal-footer">
    <a href="javascript:;" class="btn" data-dismiss="modal">Close</a>
                                <input class="btn btn-success" type="submit" name="edit_load" value="EDIT" >
