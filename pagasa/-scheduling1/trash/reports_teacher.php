           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 				     
                    ...
                    <tr class=" odd del<?php echo $section_id; ?>">
                      ...
                      <td align="center"><a class='btn btn-mini' href='report_section.php?section_id=<?php echo $section_id;?>'> VIEW </a> </td>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="reports.php"><i class=" icon-th"></i>  Teacher Reports</a>
                  <a class="btn btn-block" href="reports.php"><i class="icon-plus"></i>  Section Reports</a>
                </th>
              </tr>
            </tbody>
          </table>
