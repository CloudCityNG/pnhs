...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    ...
    <div class="widget stacked widget-table action-table">
      ...
      <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content">
          ...
          <table style="width:100%" class="table table-bordered table-striped">
            ...
            <tr >
              <td>No. of Classes: </td>
			  <td><?php echo classes_teacher($_GET['emp_id'], $school_yr);?> <br /></td>
            </tr>
            <tr >
              <td>Total Units: </td>
      ...
      <!--</span>-->
      <div class="span4">
      <a class="btn btn-large btn-success" href="report_teacher.php?emp_id=<?php echo $_GET['emp_id']?>&sy_id=<?php echo isset($_GET['sy_id'])? $_GET['sy_id']:get_active_sy();?>"><i class="icon-print"></i> PRINT </a>
      <a class="btn btn-large btn" target="_blank" href="pdf_teacher.php?emp_id=<?php echo $_GET['emp_id']?>&sy_id=<?php echo isset($_GET['sy_id'])? $_GET['sy_id']:get_active_sy();?>"><i class="icon-print"></i> PDF </a>
      </div>
    <!-- InstanceEndEditable -->
