...
if(isset($_POST['subject_title'])){
	...
	$subject_code = $lvl_id*100 + $category-100;
    if($subject_title){
        if($subject_unit){
			if(is_title_unique($subject_title)){  //is_category_unique($category, $lvl_id, NULL)
				if(true){  //is_unit_maxed($lvl_id, 0, $subject_unit)
					//$subject_unit = $_POST['subject_unit'];
		
					mysql_query("INSERT INTO subject_t VALUES('','$subject_title','$subject_unit','$lvl_id','$category','1','$curriculum_code')") or die("sala");
					mysql_query("COMMIT;");
      ...
      <div class="widget stacked widget-table action-table <?php echo isset($_GET['curriculum_code'])? "":""; ?>">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-ambulance"></i> Add Subjects</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
