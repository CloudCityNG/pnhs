    ...
    <div class="">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-list"></i> LIST OF FAILED STUDENTS</th>
              </tr>
            </thead>
            <tbody>
              <tr >
           ...
           <table cellpadding="0" cellspacing="0" border="0" class=" " id="tab<?php echo $lvl;?>" width="100%">
              ...
              <tbody>
                 ...
                 <?php 
					...
					$query_fg=mysql_query("SELECT * FROM final_grade_t WHERE student_id='$id' AND sy_id=$prev AND final_grade<75");
                            ...
                            <td><?php echo $fg; ?></td> 
                            <td><a class="btn btn-mini btn-danger" href="reg_retain-action.php<?php echo "?stud_id=$id"; ?>">Retain</a>
                            <a class="btn btn-mini btn-success" href="reg_proceed-action.php<?php echo "?stud_id=$id"; ?>">Proceed</a></td>                       	
                            </tr>
							<?php	} else if ($fg>75){
									?>
