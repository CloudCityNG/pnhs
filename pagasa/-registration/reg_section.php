...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    <div class="span13">
     ...
     <?php 
				require "../db/db.php";
				$query_yrlvl=mysql_query("SELECT * FROM year_level_t");
				while($row_yrlvl=mysql_fetch_assoc($query_yrlvl)){
					$id=$row_yrlvl['lvl_id'];
					$name=$row_yrlvl['lvl_name'];
				
			  
				  $query1=mysql_query("SELECT * FROM section_t WHERE year_level=$id");
					?>
					...
					<div class="widget-content">
						...
						<table class="table table-bordered table-striped">
                            ...
                            <tr class="del<?php echo $id ?>">
								...
								<td><a class="btn" href="reg_list_per_section.php<?php echo "?id=$row1[section_id]" ?>"><i class=icon-file></i>&nbsp;View</a> </td>
                            <?php } ?>
							</tr>                       	
