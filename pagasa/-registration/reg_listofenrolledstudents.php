    ...
    <div class="">
       ...
       <?php $query_sy=mysql_query("SELECT * FROM school_year_t WHERE SY_status=1");
        ...
        <div class="widget-content" >
         ...
         <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-list"></i>LIST OF STUDENTS S.Y.<?php echo "".$sy_start."-".$sy_end."" ?></th>
              ...
              <tbody>
                 ...
                 <?php 
					...
					while($row_reg=mysql_fetch_assoc($query_reg)){
						...
						$date_enrolled=$row_reg['reg_date'];
                           ...
                           <?php if($img!=NULL){ ?>
							...
							<td>
								<a href="../-registration/large/<?php echo $img; ?>" class="ui-lightbox">
									<img src="../-registration/include/dpic/<?php echo $img; ?>" width='50'; height='50'>
								</a>
       ...
       <?php }?>
				...
				if($rows==1){	
                 ...
                 <a class="btn btn-block" href="reg_list_of_failed_stud.php"><i class=" icon-list"></i> Failed Students</a>
                           ...
                           <tr><td>
						    <div class="control-group">
						      ...
						      <div class="controls">
						        ...
						        <input type="hidden" value=<?php echo $sy_end ?> name="current_yr" />
						        <input type="hidden" value=<?php echo $sy_end+1 ?> name="nxt_yr" />
						      </div>
						    </div> </td>
                            </tr>
