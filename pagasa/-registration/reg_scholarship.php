...
if(isset($_POST['Add'])){
		...
		$f_grant=$_POST['f_grant'];
		
		$query_s_add=mysql_query("INSERT INTO scholarship_t VALUES ('','$s_name','$grantor','$f_grant')");
	}
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example2" width="100%">
              ...
              <tbody>
                ...
                <th style="background-color:#F0F0F0">
                  <a class="btn btn-block" href="#add_scholarship" data-toggle="modal"><i class="icon-plus"></i>   Add Scholarship</a>
                  <a class="btn btn-block" href="reg_sship_delete.php"><i class="icon-trash"></i>  Delete Scholarship</a>
...
<div class="modal fade hide" id="add_scholarship">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h3>ADD SCHOLARSHIP </h3>
  </div>
  <div class="modal-body">
 						<form class="form-horizontal" name="add_scholarship" id="validation-form" action="reg_scholarship.php" method="post">
                              <fieldset>
						 <table width="" >
                        	<tr><td>
						    <div class="control-group">
						      <label class="control-label" for="name">SCHOLARSHIP NAME</label>
						      <div class="controls">
						        <input type="text" class="input-large" name="s_name" id="s_name" />
						      </div>
						    </div></td>
                           </tr>
                           <tr><td>
						    <div class="control-group">
						      <label class="control-label">GRANTOR</label>
						      <div class="controls">
						        <input type="text" class="input-large" name="grantor" id="grantor" />
						      </div>
						    </div> </td>
                            </tr>
                           <tr><td>
						    <div class="control-group">
						      <label class="control-label">FINANCIAL GRANT</label>
						      <div class="controls">
						        <input type="text" class="input-large" name="f_grant" id="f_grant" />
						      </div>
						    </div></td>
                            </tr>
      </table>
