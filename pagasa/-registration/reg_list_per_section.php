	...
	<div class="widget stacked">
        ...
        <div class="widget-content">
           ...
           <table class="table table-striped table-bordered"> 
            <thead>
              <tr>
                ...
                <th width="80%"><i class="icon-list"></i> LIST OF STUDENTS IN SECTION <?php echo strtoupper("$sec_name"); ?></th>              
              </tr>
            </thead>
            <tbody>
              <tr >
           ...
           <div id="demo" style="min-height:400px;">
            ...
            <p><strong>Male: <?php echo $count; ?></strong></p>
            <br />
            <br />
            ...
            <p><strong>Female: <?php echo $count1; ?></strong></p>
           <?php $total=$count+$count1; ?>
          <p><strong>Total Number of Students: <?php echo $total; ?></strong></p>


            <br />
            <p align="center"><a class="btn btn-success" href="fpdf/reg_masterlist_pdf.php?section_id=<?php echo $sec_id; ?>">Save as PDF</a> 

           <a class="btn btn-success" href="reg_masterlist_report.php?section_id=<?php echo $sec_id; ?>">PRINT</a> </p>
