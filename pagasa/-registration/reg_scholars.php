  				...
  				<div class="widget stacked widget-table">
					...
					<div class="widget-content">
						...
						<tbody><tr>
							<?php 
							include("../db/db.php");
							$query_scholarship=mysql_query("SELECT * from scholarship_t");
										while($row_scholarship=mysql_fetch_assoc($query_scholarship)){ 
											$s_name=$row_scholarship['scholarship_name'];
											$s_id=$row_scholarship['scholarship_id'];
							$query_stud=mysql_query("SELECT * FROM student_t WHERE scholarship=$s_id");
											$count_stud=mysql_num_rows($query_stud);
										?>
                            			<td><?php echo $s_name; ?></td>
										<td><a href="reg_scholar_report.php<?php echo "?id=$s_id&&name=$s_name"; ?>"><?php echo $count_stud; ?></a></td>
...
$(function () {
		...
		if($count_stud>=1){
		?>
		data[i] = { label: "<?php echo $s_name;?>", data: <?php echo $count_stud;?> }
		i++;
		<?php } 
		}?>
