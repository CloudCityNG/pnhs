...
if(isset($_POST['Enroll'])){
		...
		if(isset($_POST['Enroll'])) {
			...
			if($student_number==0){
				$first=1001;
				$query_stud = mysql_query("INSERT into student_t VALUES('$sy_start-$first', 'transferee', '$fname', '$mname', '$lname', '$birthdate', '$city', '$prov', '$zipcode', '$brgy', '$street',  '$name_of_parent', '$relation', '$gender', '$scholarship', '$last_sch_attended', null, '$fg')") or die("error");
				...
				$last_last=$array[1]+1;
				$query_stud = mysql_query("INSERT into student_t VALUES('$sy_start-$last_last', 'transferee', '$fname', '$mname', '$lname', '$birthdate', '$city', '$prov', '$zipcode', '$brgy', '$street',  '$name_of_parent', '$relation', '$gender', '$scholarship', '$last_sch_attended', null, '$fg')") or die("error");
				...
				$query5=mysql_query("INSERT into student_registration_t VALUES('', '$s_id', null, null, '$dateEnrolled', '$sy_id', '$year_level')") or die("'$s_id', null, null, '$dateEnrolled', '$sy_id', '$lvl_name'");
				$queryfg=mysql_query("INSERT into final_grade_t VALUES('','$s_id','$sy_id', null)") or die("$s_id','$sy_id', null");
      	 ...
      	 <div class="main">
      		...
      		<div class="widget stacked">
				...
				<div class="widget-header">
					...
					<h3>Enrollment Form for Transferees</h3>
				</div> <!-- /widget-header -->
			...
			<div style="border:1px solid #000;width:850px;margin-left:auto;margin-right:auto;">
					<form method="post" action="reg_trans_form.php" name="reg" id="validation-form" class="form-horizontal" />
						<fieldset>
                         ...
                         <tr>
                          ...
                          <div class="control-group">
				            <label class="control-label" for="validateSelect">CHOOSE YEAR LEVEL</label>
				            <div class="controls">
				   			...
				   			<select id="year_level" name="year_level">
                                ...
                                <?php
								require "../db/db.php";
								$query_yl= mysql_query("SELECT * FROM year_level_t GROUP BY lvl_name ORDER BY lvl_id ASC") or die("mali");

								 while($row_yl = mysql_fetch_assoc($query_yl)){
		    							$lvl_name = $row_yl['lvl_name']; ?>

                                <option value="<?php echo $row_yl['lvl_id']; ?>" /><?php echo $lvl_name; ?>
				               <?php } ?>
						...
						<label class="control-label" for="validateSelect">CITY/MUNICIPALITY</label>
                          ...
                          <tr><td>
                          <div class="control-group">
						      <label class="control-label" for="subject">FINAL GRADE FROM PREVIOUS SCHOOL</label>
						      <div class="controls">
						        <input type="text" class="input-large" name="final_grade" id="final_grade" />
						      </div>
						    </div>
							</td></tr>
                             </table>
