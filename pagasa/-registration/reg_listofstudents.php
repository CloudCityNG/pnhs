	...
	<div class="widget stacked">
        ...
        <div class="widget-content">
           ...
           <table class="table table-striped table-bordered"> 
			...
			$end=$_GET['end'];
			?>
                <th width="80%"><i class="icon-list"></i> LIST OF STUDENTS S.Y. <?php echo "".$start."-".$end.""; ?></th>              
              </tr>
            </thead>
            <tbody>
              <tr >
...
<p style="font-size:15px"><strong>Total Number of Students: <?php echo $count; ?></strong></p>
            <br />
        
        	 <p align="center"><a class="btn btn-success" href="fpdf/reg_listofstudents_report_pdf.php?sy_id=<?php echo $sch_yr; ?>&&start=<?php echo $start; ?>&&end=<?php echo $end; ?>">Save as PDF</a> 

         	<a class="btn btn-success" href="reg_listofstudents_report.php?sy_id=<?php echo $sch_yr; ?>&&start=<?php echo $start; ?>&&end=<?php echo $end; ?>">PRINT</a> </p>
