...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO grading_criteria (quizzes, assignments, participation, chapter_test, projects, `periodical_exam`, criteria_id) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $pagasa) or die(mysql_error());

  $insertGoTo = "grading_admin_criteria.php";
  if (isset($_SERVER['QUERY_STRING'])) {
