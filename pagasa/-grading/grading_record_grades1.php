	...
	<!-- InstanceBeginEditable name="main" -->
      <div class="widget stacked">
        <div class="widget-header"> <i class="icon-pencil"></i>
          <h3><a href="grading_class.php">CLASS RECORD</a>&nbsp;/&nbsp;<a href="grading_class_viewclass.php">VIEW CLASS&nbsp;/&nbsp;</a><font style="text-shadow:"><u>RECORD GRADES</u></font></h3>
        </div>
        <!-- /widget-header -->
        <div class="widget-content">
          <div id="demo">
            <h4><font color="#0066CC">What would you like to record?</font></h4>
          		
  			<form name="form" id="form">
  			  <select name="jumpMenu" id="jumpMenu" method="get">
  			    <option>Quizzes</option>
                <option>Chapter Tests/Long Exams</option>
		 ...
		 ?>
         <a   class="btn" onClick="window.open('grading_record_quiz.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=850, height=900,position=center');"><i class="icon-forward"></i>&nbsp;&nbsp;Continue&nbsp;&nbsp;</a>
          </div>
          </div>
        <!-- /widget-content -->
      </div>
