                  ...
                  <div id="demo" style="min-height:400px;">
                    <table cellpadding="0" cellspacing="0" border="0" class=" " id="rooms" width="100%">
                      ...
                      <tr align="center">
                                ...
                                <tr>
                            		<th><p align="center"> <i class="icon-list"></i> &nbsp; <a href="grading_class.php">SET NEW CRITERIA </p>
                                      <table border="1">
                                        <tr>
                                          <td>quizzes</td>
                                          <td>assignments</td>
                                        ...
                                        <?php do { ?>
                                          <tr>
                                            ...
                                            <td><?php echo $row_Recordset1['periodical exam']; ?></td>
                            		...
                            		<th><p align="center"> <i class="icon-user"></i> &nbsp; <a href="grading_classadvisory.php"> EDIT CRITERIA </p><a></th>
                                </tr>
