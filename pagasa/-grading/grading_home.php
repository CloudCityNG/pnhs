                ...
                <th style>
                  <div id="demo" style="min-height:400px;">
                    <table cellpadding="0" cellspacing="0" border="0" class=" " id="rooms" width="100%">
                     		<h3 align="center">WELCOME TO GRADING SYSTEM </h3>
                            <br/>
                          	<h4><font color="#0066CC">What would you like to do?</font></h4>
                            <tr align="center" bordercolor="">
                       
                                <tr>
                            		<th><p align="center"> <i class="icon-list"></i> &nbsp; <a href="grading_class.php">Check your classes </p></a></th>
                              
                            		<th><p align="center"> <i class="icon-user"></i> &nbsp; <a href="grading_classadvisory.php"> View your advisory class </p><a></th>
                                </tr>
                                <tr>
                                	<th><p align="center"> <i class="icon-print"></i> &nbsp; <a href="grading_classadvisory.php"> Print Form 138 </p><a></th>
                                	<th><p align="center"> <i class="icon-pencil"></i> &nbsp; <a href="grading_class.php"> Record Grades </p><a></th>
