            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <?php do { ?>
                              <tr>
                                ...
                                <td><a   class="btn" href="grading_admin_edit_criteria2.php?criteria_id=<?php echo $row_Recordset1['criteria_id'];?>"><span class="accordion">&nbsp;<i class="icon-edit"></i>&nbsp;Edit&nbsp;&nbsp;</span></a></td>
                              </tr>
