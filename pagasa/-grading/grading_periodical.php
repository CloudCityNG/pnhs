...
<?php 
					...
					?>
<form method="post" action="final/grading_periodical_exam_final.php"><p>
              <?php
		$query_reg=mysql_query("SELECT * FROM student_registration_t WHERE school_yr=$sch_yr");
			...
			?>
							...
							?>  
           					...
           					No. of Items<input name="periodical_examItem" type="number" value="periodical_examItem" size="5" maxlength="5"> </label>
                            <br><br>
							Subject
