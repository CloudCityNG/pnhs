...
<html lang="en">
<?php error_reporting(0); ?><!-- InstanceBegin template="/Templates/grading_template_pop.dwt.php" codeOutsideHTMLIsLocked="false" -->
<?php 
 @session_start();
...
<?php 
					...
					$date=date('Y-m-d');
					?>
<form method="post" action="final/grading_quiz_final.php"><p>
                 			...
                 			<br> <br>
           					...
           					No. of Items<input name="QuizItem" type="number" value="QuizItem" size="5" maxlength="5"> </label>
                            <br>
							Subject
							 <td> <input name="subject" value="<?php echo $subject_title; ?>">
							<br/><br/>
                           <label>Date<input name="Date" type="Date" value="<?php echo $date; ?>" >
               		  		<input type="hidden" value="<?php echo $s_id; ?>" name="subject_code" >
