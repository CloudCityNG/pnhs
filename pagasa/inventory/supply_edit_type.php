...
<?php 
 ...
 include("../db/db.php");
	...
	$sql = mysql_query("SELECT * FROM supply_type_t WHERE type_no ='$type_no'");
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
        <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"> <i class="icon-th-list"></i> SUPPLY TYPE</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
           ...
           <div id="demo" style="min-height:400px;">
            <?php
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM supply_type_t WHERE type_no='$type_no'");
					
						if($type_name) {
							require "../db/db.php";
							mysql_query("UPDATE supply_type_t SET type_name = '$type_name' WHERE type_no ='$type_no'");
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM supply_type_t ORDER BY type_no");
                        while($row=mysql_fetch_array($query)){ 
						$id=$row['type_no']; ?>
                        <tr class="del<?php echo $id ?>">
                            <td  align="center" width="100"><div align="center"><span class="style1"><?php echo $row['type_no']; ?></span></div></td>
                          <td><span class="style1"><?php echo ucfirst($row['type_name']); ?></span></td>
...
<td align="center" width="100">      
                                ...
                                <a class="btn-small btn-success" href="supply_edit_type.php?type_no=<?php echo $row["type_no"];?>"><i class="icon-pencil"></i>&nbsp;Edit</a>                                </div></td>
                      </tr>
                        <?php }?>
                </tbody>
		</table>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-pencil"> </i> Edit Supply Type </h4>
                        
                        <p>
			      		    <input name="type_name" type="text" value="<?php echo $res['type_name']; ?>" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
