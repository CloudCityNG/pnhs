  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
      ...
      <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <th width="80%"><i class="icon-user"></i> TRANSACTION LOGS</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Item</th>
                        <th> Unit </th>
                        <th title="QUANTITY RECEIVED">Quantity</th>
                    </tr>
                </thead>
                <tbody>
                 ...
                 <?php 
					...
					$query = mysql_query("SELECT *
						...
						?>
                  		<tr class="del">
                          <td align="center" height="31"><div align="center" class="style2"><?php echo ucfirst($row['date_recieved']); ?></div></td>
                          <td align="center"><span class="style2"><?php echo ucfirst($row['f_name'])." ".ucfirst($row['m_name'])." ".ucfirst($row['l_name']); ?></span></td>
                          <td align="center"><div align="center" class="style2"><?php echo ucfirst($row['stock_no']); ?></div></td>
                          <td align="center"><span class="style2"><?php echo ucfirst($row['description'])." ".ucfirst($row['category'])." ".ucfirst($row['item_name']); ?></span></td>
                   		  <td align="center"><span class="style2"><?php echo ucfirst($row['unit_type']); ?></span></td>
        <td align="center"><div align="center" class="style2">
                              <?php $row1=mysql_fetch_array($quantity); echo $row1['quantity'];?>
                          </div></td>
                          <!--<td><div align="center">
                             <a class="btn-small btn-success" title="VIEW DETAILS" onClick="window.open('supply_view_record.php?record_id=<?php echo $row["record_id"];?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-list-alt"></i></a> 
                            </div></td>-->
                        </tr>
