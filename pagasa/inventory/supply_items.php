            ...
            <?php
				...
				require "../db/db.php";
					...
					if(mysql_num_rows($query) > 0) {
						...
						if($item_name) {
							require "../db/db.php";
							mysql_query("INSERT INTO inventory_item_t VALUES('','$item_name')");
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
                    ...
                    <tr class="del<?php echo $id ?>">
                      <td align="center" width="100"><div align="center"><span class="style1"><?php echo $row['item_no']; ?></span></div></td>
                      ...
                      <td align="center" width="150">      
                        ...
                        <a class="btn-small btn" href='supply_edit_items.php?item_no=<?php echo $row["item_no"];?>'><i class="icon-pencil"></i>&nbsp;Edit</a>    &nbsp;     
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add Supply Item </h4>
                        
                        <p>
			      		    <input name="item_name" type="text" placeholder="Enter Item Name" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
