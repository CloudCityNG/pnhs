...
<?php 
 ...
 include("../db/db.php");
	...
	$sql = mysql_query("SELECT * FROM equipment_color_t WHERE color_id ='$color_id'");
           ...
           <?php
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM equipment_color_t WHERE color_name='$color_name'");
						...
						if($color_name) {
							require "../db/db.php";
							mysql_query("UPDATE equipment_color_t SET color_name = '$color_name' WHERE color_no = '$color_no' ");
...
<td align="center" width="150">      
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Edit Color </h4>
                        
                        <p>
			      		    <input name="color_name" type="text" value="<?php echo ucfirst($res['color_name']); ?>" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
