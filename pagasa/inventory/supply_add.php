      	...
      	<div class="span12">
      	 <div class="main">
			...
			<div style="border:1px solid #000; width:auto; margin-left:auto; margin-right:auto;">
					...
					<form method="post" action="actions/supply_add_action.php" name="reg" id="validation-form" class="form-horizontal" />
						<fieldset>
						<table class="table1" width="908" >
                          <tr>
                            <td colspan="8" style="background-color:#969696;font-size:30px;font-style:italic;"><p><strong>&nbsp; SUPPLY DETAILS</strong></p>
                            </td>
                          </tr>
                          <tr>
                            <td><div class="control-group">
                                <label class="control-label" for="name">
                              REQUISITION AND ISSUE SLIP</label>
                            ...
                            <td><div class="control-group">
                              ...
                              RESPONSIBLITY CENTER CODE</label>
                                <div class="controls"><br>
                            ...
                            <td><div class="control-group">
                                ...
                                <div class="controls">
                                  <select name="type_no">
                     				 <?php
		  								include('../db/db.php');
										$sql = "select * from supply_type_t";
										$type = mysql_query($sql);
			 				 			echo "<option value='' selected='selected' disabled='disabled'>Select Type</option>";
			 				 				while($row = mysql_fetch_array($type)) {
			  					  			echo "<option value='".$row['type_no']."'>".ucfirst($row['type_name'])."</option>";
			  				 			}
		  							?>
            					  </select>
                                </div>
                          ...
                          <tr>
                            <?php include('supply_add_itemrecord.php'); ?>
                          </tr>
