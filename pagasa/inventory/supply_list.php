                 ...
                 <?php 
					...
					$query=mysql_query("SELECT *
                        ...
                        <tr class="del<?php echo $id ?>">
                          <td align="center" width="40"><div align="center" class="style1"><?php echo $row['stock_no']; ?></div></td>
                          <td><span class="style1"><?php echo ucfirst($row['item_name']); ?></span></td>
                          <td><span class="style1"><?php echo ucfirst($row['category']); ?></span></td>
                          <td><span class="style1"><?php echo ucfirst($row['description']); ?></span></td>
<td width="90">
                          ...
                          <td width="55"><span class="style1"><?php echo ucfirst($row['unit_type']); ?></span></td>
    ...
    <td align="center" width="80">      
                            ...
                            <a class="btn-medium btn" title="VIEW DETAILS" href="supply_tracking.php?stock_no=<?php echo $row["stock_no"];?>"><i class="icon-search"></i></a>
                            <a class="btn-medium btn" title="ADD STOCK" onClick="window.open('supply_add_stock.php?stock_no=<?php echo $row["stock_no"];?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-plus"></i></a>                            </td>
                        </tr>
                        <?php }?>
                </tbody>
		</table>
