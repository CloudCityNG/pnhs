...
<?php 
 ...
 include("../db/db.php");
	...
	$sql = mysql_query("SELECT * FROM equipment_category_detail, equipment_category_t 
						WHERE equipment_category_detail.detail_no ='$detail_no' AND equipment_category_detail.category_id=equipment_category_t.category_id");
...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
	  ...
	  $data = "SELECT * FROM equipment_category_t WHERE category_id='$category_id'";
	  	$re = mysql_query($data);
	...
	?>
        ...
        <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><i class="icon-list-alt"></i> EQUIPMENT ITEM LIST</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              <tr >
                <th >
                  <h3>&nbsp;<?php echo ucfirst($row["item_name"]); ?>'s Brands</h3>
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM equipment_category_t WHERE item_name='$item_name' AND category_id='$category_id'");
					
						if($category) {
							require "../db/db.php";
							mysql_query("UPDATE equipment_category_detail SET category = '$category' WHERE detail_no = '$detail_no'");
                ...
                <tbody>
                 ...
                 <?php 
					$query=mysql_query("SELECT *
										FROM equipment_category_t, equipment_category_detail 
										WHERE equipment_category_detail.category_id = equipment_category_t.category_id
										AND equipment_category_t.category_id='$category_id'");
                        while($row=mysql_fetch_array($query)){ 
						$id=$row['detail_no']; ?>
                        <tr class="del<?php echo $id ?>">
                            <td align="center"><div align="center"><span class="style1"><?php echo ucfirst($row['category']); ?></span></div></td>
...
<td align="center" width="200">      
                              ...
                              <a class="btn-small btn-success" href="equipment_edit_detail.php?detail_no=<?php echo $row["detail_no"];?>"><i class="icon-pencil"></i> &nbsp;Edit</a> </div></tr>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="../inventory/equipment_color.php"><i class="icon-picture"></i>   Colors</a>
                   ...
                   <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-pencil"> </i> Edit Brand </h4>
                        <p>
			      		    <input name="category" type="text" value="<?php echo ucfirst($res['category']); ?>" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
