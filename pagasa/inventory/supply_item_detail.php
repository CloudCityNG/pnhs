...
<!--
.style3 {font-size: 12}
.style4 {-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; padding: 0 6px;}
              ...
              <tr >
				...
				require "../db/db.php";
					...
					if(mysql_num_rows($query) > 0) {
						...
						if($category) {
							require "../db/db.php";
							mysql_query("INSERT INTO supply_category_t VALUES('','$item_no','$category')");
					...
					header('Location : supply_item_detail.php?item_no=$row["item_no"]'); 
				}	
			?>
                  
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="  style3" id="example">
                <thead>
                    <tr>
                 ...
                 <?php 
					...
					$query=mysql_query("SELECT *
                        ...
                        <tr class="del<?php echo $id ?>">
                            <td align="center"><div align="center" class="style5"><?php echo ucfirst($row['category']); ?></div></td>
                            <td>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add New Category </h4>
                        <p>
