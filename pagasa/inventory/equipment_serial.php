  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <th width="80%"><i class="icon-map-marker"></i> SERIAL NUMBER</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
          ...
          <div id="demo" style="min-height:400px;">
            ...
            <div class="tabbable">
				<ul class="nav nav-tabs">
                	  <li class="active"><a href="#details" data-toggle="tab"><i class="icon-list-alt"></i> Details</a></li>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$id = $_GET['id'];
					$que = mysql_query("SELECT * FROM equipment_property_t, equipment_serial_t, employee_t
										WHERE equipment_property_t.property_no = equipment_serial_t.property_no
										AND employee_t.emp_id = equipment_property_t.emp_id
										AND equipment_serial_t.id= '$id'");
										
                        while($row=mysql_fetch_array($que)){ 
						$id=$row['id']; ?>
                        <tr class="del<?php echo $id ?>">
                            <td class="style1" height="30"><?php echo $row['serial_no']; ?></td>
                            <td align="center" class="style1"><?php echo ucfirst($row['f_name'])." ".ucfirst($row['m_name'])." ".ucfirst($row['l_name']); ?></td>
                            <td align="center" class="style1"><?php echo $row['date_acquired']; ?></td>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="equipment_serial.php" class="form-horizontal">
                        <div align="center">
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
