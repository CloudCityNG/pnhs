           ...
           <?php
				...
				require "../db/db.php";
					...
					if(mysql_num_rows($query) > 0) {
						echo"<p class='remove-box'>&nbsp;&nbsp;&nbsp;<b>Category Already Exists!!</p>";
					}
					else {
						if($item_name) {
							require "../db/db.php";
							mysql_query("INSERT INTO equipment_category_t VALUES('','$item_name')");
...
<td align="center" width="150">      
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add Equipment Item </h4>
                        
                        <p>
			      		    <input name="item_name" type="text" placeholder="Enter Item" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
