            ...
            <tbody>
              <tr >
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM equipment_category_detail WHERE category_id='$id' AND category='$category'");
					if(mysql_num_rows($query) > 0) {
						echo"<p class='remove-box'>&nbsp;&nbsp;&nbsp;<b>Brand Name Already Exists!!</p>";
					}
					else {
						if($category) {
							require "../db/db.php";
							mysql_query("INSERT INTO equipment_category_detail VALUES('','$category_id','$category')");
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="../inventory/equipment_color.php"><i class="icon-picture"></i>   Colors</a>
                   ...
                   <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add New Brand </h4>
                        <p>
			      		    <input name="category" type="text" placeholder="Enter Category" style="width:160px">
