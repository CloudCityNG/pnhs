           ...
           <?php
				...
				require "../db/db.php";
					...
					if(mysql_num_rows($query) > 0) {
						echo"<p class='remove-box'>&nbsp;&nbsp;&nbsp;<b>Supplier Already Exists!!</p>";
					}
					else {
					  if($supplier_name){
					   if($address){
						if($contact_no) {
							require "../db/db.php";
							mysql_query("INSERT INTO inventory_supplier_t values('','$supplier_name','$address','$contact_no')");
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <th style="background-color:#F0F0F0">
                   ...
                   <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        <div align="center">
                        <h4> <i class="icon-plus-sign-alt"> </i> Add Supplier </h4>
			      		  <p>&nbsp;			      		  </p>
			      		  <p>Supplier Name 
			      		    <input name="supplier_name" type="text" placeholder="Supplier Name" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>Address 
                            <input name="address" type="text" placeholder="Address" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>Contact No. 
                            <input name="contact_no" type="text" placeholder="Contact No." style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
