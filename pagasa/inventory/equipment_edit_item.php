...
<?php 
 ...
 include("../db/db.php");
	...
	$sql = mysql_query("SELECT * FROM equipment_category_t WHERE category_id ='$category_id'");
        ...
        <div class="widget-content">
           ...
           <?php
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM equipment_category_t WHERE item_name='$item_name'");
					
						if($item_name) {
							require "../db/db.php";
							mysql_query("UPDATE equipment_category_t SET item_name = '$item_name' WHERE category_id = '$category_id'");
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM equipment_category_t ORDER BY category_id");
                        while($row=mysql_fetch_array($query)){ 
						$id=$row['category_id']; ?>
                        <tr class="del<?php echo $id ?>">
                            <td  align="center" width="100"><div align="center" class="style1"><?php echo $row['category_id']; ?></div></td>
...
<td align="center" width="150">      
							...
							<a class="btn-mini btn" href="equipment_edit_item.php?category_id=<?php echo $row["category_id"];?>"><i class="icon-pencil"></i> &nbsp;Edit</a>&nbsp;
                            <a class="btn-small btn-success" href='equipment_item_detail.php?category_id=<?php echo $row["category_id"]?>'><i class="icon-list"></i>&nbsp;Brand</a>                            </td>
                        </tr>
                        <?php }?>
                </tbody>
		</table>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-pencil"> </i> Edit Equipment Item </h4>
                        
                        <p>
			      		    <input name="item_name" type="text" value="<?php echo ucfirst($res['item_name']); ?>" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
