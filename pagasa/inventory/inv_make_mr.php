            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					...
					$qry = mysql_query("SELECT * FROM equipment_record_t WHERE qoh >= '1'");
				    while($row = mysql_fetch_array($qry)){
						...
						$query2 = mysql_fetch_array(mysql_query("SELECT * FROM equipment_category_detail WHERE category_id='$category_id'"));
						 ...
						 mysql_query("Commit");
					?>
                            <td  align="center" width="80"><div align="center" class="style1"><?php echo "$stock_no"; ?></div></td>
                            <td align="center"><div align="left" class="style1"><?php echo $specs." ".ucfirst($color1)." ".ucfirst($category)." ".ucfirst($item_name); ?></div></td>	
                            <td align="center" width="130"><div align="center" class="style1"><?php echo ucfirst($row["qoh"]); ?></div></td>
                            <td align="center" width="180">
                              <div align="center"><a class="btn btn-success" onClick="window.open('inv_create_mr.php?stock_no=<?php echo $row["stock_no"]; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-pencil"></i> Create MR</a>                                </div></td>
                            ...
                            <td align="center" width="100">      
                              <div align="center">
                                ...
                                <a class="btn btn-success" onClick="window.open('inv_view_item.php?stock_no=<?php echo $row["stock_no"]; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-list"></i> Details</a>                                </div></td>
