...
<?php 
 ...
 include("../db/db.php");
	...
	$sql = mysql_query("SELECT * FROM inventory_item_t WHERE item_no ='$item_no'");
        ...
        <div class="widget-content">
           ...
           <div id="demo" style="min-height:400px;">
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM inventory_item_t WHERE item_name='$item_name'");
					
						if($item_name) {
							require "../db/db.php";
							mysql_query("UPDATE inventory_item_t SET item_name='$item_name' WHERE item_no = '$item_no'");
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM inventory_item_t ORDER BY item_no");
                    
					while($row=mysql_fetch_array($query)){ 
					$id=$row['item_no']; ?>
                    
                    <tr class="del<?php echo $id ?>">
                      <td align="center" width="200"><span class="style1"><?php echo $row['item_no']; ?></span></td>
                      <td align="center"><span class="style1"><?php echo ucfirst($row['item_name']); ?></span></td>
                      ...
                      <td align="center" width="150">      
                        ...
                        <a class="btn-mini btn" href='supply_edit_items.php?item_no=<?php echo $row["item_no"];?>'><i class="icon-pencil"></i>&nbsp;Edit</a>    &nbsp;     
                        <a class="btn-small btn-success" href='supply_item_detail.php?item_no=<?php echo $row["item_no"];?>'><i class="icon-list"></i>&nbsp;Details</a> 
                        
						<!--<a class="btn btn-danger" href="JavaScript:if(confirm('Are you sure you want to delete this record?')==true)
							{window.location='actions/delete_item.php?item_no=<?php echo $row["item_no"];?>';}"><img src="icons/application_delete.png">&nbsp;Delete</a>-->                      </td>                            
                    </tr>
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Edit Supply Item </h4>
                        
                        <p>
			      		    <input name="item_name" type="text" value="<?php echo $res['item_name']; ?>" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
