...
<p align="center" class="style2">Name of Local Goverment Unit: Pag Asa National high School Date: <?php echo date('m/d/Y'); ?>  Issue No
<?php echo date ('m')?></p>
<div align="center">
    ...
    <tr align="center" valign="middle" bgcolor="#FFFFFF">
      ...
      <?php
				    error_reporting(0);
						...
						$query6 = mysql_query(mysql_query("SELECT * FROM equipment_category_t WHERE color_id='$color_id'"));
				  		$color_name=$query6['color_name'];
				...
				?>
						...
						<tr>
							  ...
							  <td bgcolor='#B1F3B4'><div align='center'><?php echo $quantity_acquired; ?></div></td>
							  <td bgcolor='#B1F3B4'><div align='center'>
							  <?php
							  include ('../db/db.php');
	  			  			 $property_no = $_GET['property_no'];
							  $serial = mysql_query("SELECT * FROM equipment_serial_t WHERE property_no = '$property_no'");
							  while($row=mysql_fetch_array($serial)){
							  	echo $row['serial_no']."<br>";
							 }
							  ?>
							   </div></td>
							   <td bgcolor='#B1F3B4'><div align='center'><?php echo $unit_type ?></div></td>
							   <td bgcolor='#B1F3B4'><div align='center'><?php echo ucfirst($item_name)." ".ucfirst($category)." ".ucfirst($color1)." ".ucfirst($specs); ?></div></td>
							  <td bgcolor='#B1F3B4'><div align='center'><?php echo $date_acquired; ?></div></td>
							  <td bgcolor='#B1F3B4'><div align='center'><?php echo $property_no; ?></div></td>
							   <td bgcolor='#B1F3B4'><div align='center'><?php echo "Php".$amount; ?></div></td>
							  <td bgcolor='#B1F3B4'><div align='center'><?php  echo"Php ".$total=($quantity_acquired*$amount); ?></div></td>
						 </tr>
                <?php } ?>
    </tr>
  </table>
