  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
      ...
      <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><i class="icon-file-alt"></i> RETURNED EQUIPMENT</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <?php 
					...
					$qry = mysql_query("SELECT * FROM equipment_property_t WHERE status='returned'");
					...
					$query3 = mysql_fetch_array(mysql_query("SELECT * FROM equipment_category_t WHERE category_id='$category_id'"));
						...
						?>
                            <td align="center" width="100"><div align="center"><?php echo $row["property_no"]; ?></div></td>
                            <td align="center" width="100"><div align="center"><?php echo "$stock_no"; ?></div></td>
							<td align="center">
							<a onClick="window.open('inv_view_item.php?stock_no=<?php echo $row["stock_no"]; ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');">
							<?php echo ucfirst("$item_name"); ?></a></td>
                            <td align="center" width="150"><div align="center"><?php echo ucfirst("$quantity_acquired"); ?></div></td>
