  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <th width="80%"><i class="icon-briefcase"></i> EQUIPMENT LIST</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$qry = mysql_query("SELECT * FROM equipment_record_t");
				    while($row = mysql_fetch_array($qry)){
						...
						?>
                        <tr>
                            <td width="50" height="31" align="center" class="style1"><div align="center"><?php echo "$stock_no"; ?></div></td>
                            <td align="center" class="style1"><?php echo ucfirst($category)." ".ucfirst($item_name) ; ?></td>	
                            <td align="center" class="style1"><?php echo ucfirst($unit_type); ?></td>
                             <td align="center" class="style1"><div align="center"><?php echo ucfirst($row["amount"]); ?></div></td>	
                            <td align="center" class="style1"><div align="center"><?php echo ucfirst($row["quantity"]); ?></div></td>
                             <td align="center" class="style1"><?php if(date('Y') <= ($row["life_span"]+$date)){ echo "Useful";} else {echo "Depreciated"; }?> </td>	
                             <td align="center" class="style1"><div align="center"><?php echo ucfirst($row["life_span"]); ?></div></td>	
                            <td align="center" class="style1"><div align="center"><?php echo ucfirst($date); ?></div></td>
</tr>
     					<?php  }  ?>
