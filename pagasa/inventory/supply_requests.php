      ...
      <div class="widget stacked">
        ...
        <div id="demo" style="min-height:400px;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table-hover" id="example" width="100%">
                <thead>
                    <tr>
                        <th><p class="style4">Date Requested</p></th>
                        <th><p class="style4">Employee Name</p></th>
                        <th><p class="style4">Item</p></th>
                        <th><p class="style4">Unit</p></th>
                        <th><p class="style4">Quantity</p></th>
                        <th><p class="style4">Confirm</p></th>
                      	<th><p class="style4">Cancel</p></th>
                    </tr>
                </thead>
                <tbody>
                 ...
                 <?php 
							...
							?>
           				<tr class="del">
               		      	<td align="center" ><p class="style3"><?php echo ucfirst($row['date_recieved']); ?></p></td>
                            <td align="center" ><span class="style3"><?php echo "".ucfirst($row['f_name'])." ".ucfirst($row['m_name'])." ".ucfirst($row['l_name']).""; ?></span></td>
                            <td align="center" ><span class="style3"><?php echo ucfirst($row['description'])." ".ucfirst($row['category'])." ".ucfirst($row['item_name']); ?></span></td>
                            <td align="center" width="100" ><span class="style3"><?php echo ucfirst($row['unit_type']); ?></span></td>
                   		    <td align="center" ><span class="style3">
               		        <?php $row1=mysql_fetch_array($quantity); echo $row1['quantity']; ?>
                   		    </span></td>
                            <td align="center" >
                            <a class="btn-small btn-success" href="supply_check_request.php?sd_id=<?php echo $row["sd_id"];?>" title="CHECK REQUEST"><i class="icon-check"></i></a>                            </td>
                            <td align="center" >
                            <a class="btn-small btn-danger" href="supply_cancel_request.php?sd_id=<?php echo $row["sd_id"];?>" title="CANCEL REQUEST"><i class="icon-remove"></i></a>                            </td>
                        </tr>
