        ...
        <div class="widget-content">
           ...
           <?php
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM supply_type_t WHERE type_name='$type_name'");
					if(mysql_num_rows($query) > 0) {
						echo"<p class='remove-box'>&nbsp;&nbsp;&nbsp;<b>Supply Type Already Exists!!</p>";
					}
					else {
						if($type_name) {
							require "../db/db.php";
							mysql_query("INSERT INTO supply_type_t VALUES('','$type_name')");
...
<td align="center" width="100">      
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']?>" class="form-horizontal">
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add Supply Type </h4>
                        
                        <p>
			      		    <input name="type_name" type="text" placeholder="Enter Type" style="width:160px">
			      		  </p>
			      		  <p>&nbsp; </p>
			      		  <p>
