  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
        <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><i class="icon-file-alt"></i> BORROWED EQUIPMENT</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
                 ...
                 <?php 
					...
					$query3 = mysql_fetch_array(mysql_query("SELECT * FROM equipment_category_t WHERE category_id='$category_id'"));
						...
						?>
                            ...
                            <td align="center"><div align="center"><?php echo "$stock_no"; ?></div></td>
							<td align="center">
                            ...
                            <td align="center"><?php echo ucfirst("$quantity_acquired"); ?></td>
