                ...
                <thead>
                    <tr>
                        <th><div align="center">ID</div></th>
		         		<th width="202"><div align="center">Name</div></th>
            	 		<th width="213"><div align="center">Description</div></th>
                 ...
                 <?php 
					...
					$query=mysql_query("SELECT * FROM department_t");
                        ...
                        <tr class="del<?php echo $id ?>">
                            <td align="center" width="60"><div align="center"><?php echo $row['dept_id']; ?></div></td>
