				...
				<ul class="mainnav">
                    ...
                    <li>
                        <a href="../admin_equip_home.php" >
                    	 ...
                    	 <li>
                        <a href="../admin_accounts_home.php" >
                            <i class="shortcut-icon icon-user"></i>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="min-height:400px;">
  ...
  <div class="carousel-inner">
    <div class="item active ">
      <img src="../images/banner_eis.jpg" alt="eis" class="container" style="width:80%;">
      
    </div>
    <div class="item hide">
      <img src="../images/banner_sis.jpg" alt="eis" class="container" style="width:80%;">
