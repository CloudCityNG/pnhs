...
require "../db/db.php";
	...
	if ($password == $repassword){
	   ...
	   $query = mysql_query("SELECT account_no FROM account_t WHERE username = '$username' AND password='$password' AND type= '$type' ");
	   $row = mysql_fetch_array($query);
	   $acc_id = $row['account_no'];
	   
	   $sql2 = mysql_query("INSERT INTO account_permission_t VALUES ('$acc_id', '$privilege_id')");
	   $sql3 = mysql_query("INSERT INTO account_t VALUES ('$acc_id', '$type')");
                      ...
                      <tr>
                          ...
                          <td><div class="control-group">
							  ...
							  <select name="privilege_id">
		  							<?php
		  							include('../db/db.php');
									$sql = mysql_query("SELECT * FROM account_privilege_t WHERE privilege_level='0' OR privilege_level='3' ");
