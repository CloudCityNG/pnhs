					...
					<br />
						...
						<div class="tab-content">
							<div class="tab-pane active" id="profile">
                  			...
                  			<form action="actions/ams_edit_nonaccountemp_action.php" method="post" class="form-horizontal" />
						...
						AND account_t.account_no='$no'");
						$row1 = mysql_fetch_assoc($sql1);
						echo strtoupper($row1['privilege_name']); ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
                            ...
                            <div class="tab-pane" id="delete">
                              ...
                              <a class="btn btn" title="Delete Account" href="JavaScript:if(confirm('Are you sure you want to delete this account?')==true){window.location='actions/ams_delete_account_action.php?account_no=<?php echo $no; ?>';}"><i class="icon-remove"></i>&nbsp;Delete Account</a>   
