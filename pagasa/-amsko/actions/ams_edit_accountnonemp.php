	...
	?>
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-edit">&nbsp;&nbsp;&nbsp;&nbsp;</i> Edit Accounts</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              <tr >
                <th ><div id="demo" style="min-height:400px;">
                  ...
                  <p>&nbsp;</p>
                  <form action="actions/ams_edit_accountemp_action.php" method="post">
                    <input type="hidden" name="account_no" value="<?php echo $row['account_no']; ?>">
                    <table width="70%">
                      <tr>
                        <td>Account No.</td>
                        <td><?php echo strtoupper($row['account_no']); ?></td>
                      </tr>
                    <tr>
                        <td height="35">Account Type</td>
                      ...
                      <tr>
                        <td colspan="2"><p>&nbsp; </p>
                            <div align="left">
                              ...
                              <a href="ams_emp_accounts.php">CANCEL</a>
                              </button>
                              &nbsp;
                              
          <a class="btn btn-danger" title="Delete Account" href="JavaScript:if(confirm('Are you sure you want to delete this account?')==true){window.location='actions/ams_delete_account_action.php?account_no=<?php echo $no; ?>';}"><i class="icon-remove"></i>&nbsp;Delete</a>  
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" onClick="window.open('ams_add_account_choice.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-plus-sign"></i> Add Account</a>
