    ...
    <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="78%"><i class="icon-list">&nbsp;&nbsp;&nbsp;&nbsp;</i>List of Non Employee Accounts</th>
                <th width="22%"></th>
              </tr>
            </thead>
            <tbody>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                <thead>
                    <tr>
                                ...
                                <th width="171"><div align="center">Username</div></th>
                          <th width="250"><div align="center">Role/s</div></th>
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM account_t WHERE type='admin' OR type='student'");
                        ...
                        <tr class="del<?php echo $id ?>">
                          ...
                          <td><?php echo ($row['username']); ?></td>
                            <td><?php 
							$sql=mysql_query("SELECT * FROM account_privilege_t, account_permission_t, account_t
        ...
        <div align="center">
                                  <script type="text/javascript">
                                    jQuery(document).ready(function() {
                                      ...
                                      <a class="btn-mini btn" title="View Details and Update Acccount" href='ams_edit_accountnonemp.php?account_no=<?php echo $row["account_no"];?>'><i class="icon-search"></i>&nbsp;Details / <i class="icon-pencil"></i>&nbsp;Update</a> &nbsp;
                         <!--           
                          <a class="btn-small btn-danger" title="DELETE" href="JavaScript:if(confirm('Are you sure you want to delete this account?')==true)
							{window.location='actions/ams_delete_empaccount_action.php?account_no=<?php echo $row["account_no"];?>';}"><i class="icon-remove"></i>&nbsp;Delete</a>
                            -->                                </div></td>
                        </tr>
                  <?php }?>
                </tbody>
