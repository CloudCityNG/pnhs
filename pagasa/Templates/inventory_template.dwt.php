...
<div class="subnavbar">
	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			</a><!-- TemplateBeginEditable name="navbar" -->
			<div class="subnav-collapse collapse">
			  <ul class="mainnav">
			    <li class="active"> <a href="../inventory/inv_home.php"> <i class="icon-home"></i> <span>Home</span></a></li>
			    <li> <a href="../inventory/inv_logs.php" > <i class="shortcut-icon icon-group"></i> <span class="shortcut-label">Transaction Logs</span></a></li>
			    <li> <a href="../inventory/supply_list.php" > <i class="shortcut-icon icon-shopping-cart"></i> <span class="shortcut-label">Supplies</span></a></li>
			    ...
			    <li> <a href="../inventory/inv_units.php" > <i class="shortcut-icon icon-list"></i> <span class="shortcut-label">Units</span></a></li>
                <li> <a href="../inventory/inv_supplier.php" > <i class="shortcut-icon icon-building"></i> <span class="shortcut-label">Supplier</span></a></li>
			    <li> <a href="../inventory/inv_reports.php" > <i class="shortcut-icon icon-file"></i> <span class="shortcut-label">Reports</span></a></li>
		      </ul>
		    </div>
			<!-- TemplateEndEditable -->
...
<!-- TemplateBeginEditable name="extra" -->
