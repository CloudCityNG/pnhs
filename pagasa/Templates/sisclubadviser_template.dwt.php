				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							$queryid = mysql_query("SELECT * FROM club_adv_account_t WHERE account_no = '$user'");
	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			<!-- TemplateBeginEditable name="navbar" -->
			  <ul class="mainnav">
                <li class="active"> <a href="ca-home.php"> <i class="icon-calendar"></i> <span>Home</span> </a> </li>
