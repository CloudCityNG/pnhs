	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			<div class="subnav-collapse collapse">
			  <ul class="mainnav">
			    <li class="active"> <a href="../AMS/ams_home.php"> <i class="icon-home"></i> <span>Home</span></a></li>
			    <li> <a href="../AMS/account_list.php" > <i class="shortcut-icon icon-user"></i> <span class="shortcut-label">Accounts</span></a></li>
		      </ul>
		    </div>
			<!-- TemplateEndEditable -->
