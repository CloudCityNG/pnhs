						       ...
						       <?php } else {?>
            					            <?php if($gender == 'female' || $gender == 'Female' ){?>      
             								<img src="library/img/girl.jpg" >
                                            	<img src="library/img/shadow-project.png">
                                <?php } 
											else{ ?><img src="library/img/boy.jpg"> <? }?>
							                <?php }
       ...
       <br />
        <div class="span 7">
				...
				<div class="widget-content">
					 ...
					 <div class="shortcuts">
            <a href="-registration/reg_homepage.php" class="shortcut">
            ...
            <a href="inventory/inv_home.php" class="shortcut">
                ...
                <a href="-ams/ams_home.php" class="shortcut">
                <i class="shortcut-icon icon-user"></i>
