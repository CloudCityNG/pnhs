...
if($username && $password)
{
	...
	if($numrows != 0){
		...
		if($username==$dbusername && $password==$dbpassword){ 
			...
			echo"<p class='warning-box'>&nbsp;&nbsp;&nbsp;<b>Incorrect Password!</p>";
	}

	else {
		echo"<p class='warning-box'>&nbsp;&nbsp;&nbsp;<b>The username doesn't exist!</p>";
	}
}

else {
	echo"<p class='remove-box'>&nbsp;&nbsp;&nbsp;<b>All fields are required!</p>";
