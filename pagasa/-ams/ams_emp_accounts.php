    ...
    <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-list">&nbsp;&nbsp;&nbsp;&nbsp;</i>List of Accounts</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
                 ...
                 <?php 
					...
					$query=mysql_query("SELECT * FROM account_t WHERE type='employee'");
                        ...
                        <tr class="del<?php echo $id ?>">
                            <td align="center" width="110"><?php echo $row['account_no']; ?></td>
                        ...
                        <div align="center">
                                  <script type="text/javascript">
                                    jQuery(document).ready(function() {
                                      ...
                                      <a class="btn-mini btn" title="EDIT ACCOUNT" href='ams_edit_account.php?account_no=<?php echo $row["account_no"];?>'><i class="icon-pencil"></i>&nbsp;Edit</a>
