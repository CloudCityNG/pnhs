  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="main" -->
        <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"> <i class="icon-file-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Account Types</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%">
                ...
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM account_type_t ORDER BY type_no");
                        while($row=mysql_fetch_array($query)){ 
						$id=$row['type_no']; ?>
                        <tr class="del<?php echo $id ?>">
                          <td  align="center"><?php echo $row['type_no']; ?></td>
                          <td><?php echo ucfirst($row['type_name']); ?></td>
                          <td align="center"><a class="btn-mini btn-danger" href="JavaScript:if(confirm('Are you sure you want to delete this record?')==true)
							{window.location='actions/delete_unit.php?unit_no=<?php echo $row["type_no"];?>';}"><i class="icon-remove"></i>&nbsp;Delete</a></td>
                        </tr>
                        <?php }?>
                </tbody>
		</table>
                  ...
                  <a class="btn btn-block" href="account_module.php"><i class="icon-lock"></i> System Admins</a>   
                	...
                	<form method="post" class="form-horizontal">
                      <div align="center">
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h4> <i class="icon-plus-sign-alt"> </i> Add Account Type </h4>
             ...
             <?php
				...
				require "../db/db.php";
					...
					$query = mysql_query("SELECT * FROM account_type_t WHERE type_name='$type_name'");
					if(mysql_num_rows($query) > 0) {
						echo "<div class='alert alert-error'>";
						echo "Account Type is already exists!";
						echo "</div>";
					}
					else {
						if($type_name) {
							require "../db/db.php";
							mysql_query("INSERT INTO account_type_t VALUES('','$type_name')");
							echo "<div class='alert alert-success'>";
							echo "New Type is added!";
							echo "</div>";
						}	
						else {
