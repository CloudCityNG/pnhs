	...
	<!-- InstanceBeginEditable name="main" -->
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th colspan="2"><i class="icon-plus">&nbsp;&nbsp;&nbsp;&nbsp;</i> Add New Account</th>
              </tr>
            </thead>
            <tbody>
              <tr >&nbsp;
              ...
              &nbsp;
                ...
                &nbsp;&nbsp;</p>
                  <div id="demo" style="min-height:400px;">
                    <a class="btn btn-block" onClick="window.open('ams_add_accountemp.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-plus-sign">&nbsp;&nbsp;&nbsp;&nbsp;</i>Employee</a>
                    
                    <a class="btn btn-block" onClick="window.open('ams_add_account.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=600,position=center');"><i class="icon-plus-sign">&nbsp;&nbsp;&nbsp;&nbsp;</i>Non-Employee</a>
                ...
                <th colspan="2">
                  ...
                  <a class="btn btn-block" href="ams_emp_accounts.php"><i class="icon-user"></i> Employee Accounts</a>           </th>
              </tr>
            </tbody>
          </table>
        </div>
