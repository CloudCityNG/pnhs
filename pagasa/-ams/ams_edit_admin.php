...
$sql = mysql_query("SELECT * FROM account_admin_t WHERE admin_no = '$admin_no' ");
while($row=mysql_fetch_array($sql)){ 
$query = mysql_query("SELECT * FROM account_admin_t WHERE admin_no = '$admin_no' ");
?>  
      <div class="widget-content">
          ...
          <div id="demo" style="min-height:400px;">
          	...
          	<form action="ams_edit_admin.php" method="post">
            <input type="hidden" name="admin_no" value="<?php echo $admin_no; ?>">
            <table width="70%">
			  <tr>
			    <td>Employee Name</td>
			    <td>
			  ...
			  <tr>
			    <td colspan="2"><p>&nbsp; </p>
                  <div align="center">
                  	<button class="btn btn"><a href="account_admin.php?module_no=<?php echo $row['module_no']; ?>">CANCEL</a></button>&nbsp;
                    <button class="btn btn-danger"><a href="account_admin.php?admin_no=<?php echo $row['admin_no']; ?>" class="style1">UNAFFILIATE</a></button>&nbsp;
