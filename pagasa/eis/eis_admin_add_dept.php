...
?>  
      <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><i class="icon-group"></i> ADD DEPARTMENT</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
          ...
          <div id="demo" style="min-height:400px;">
          	...
          	<p>&nbsp;</p>
          	<form action="actions/eis_add_dept_action.php" method="post">
            <table width="70%">
			  <tr>
			  ...
			  <tr>
			    <td colspan="2"><p>&nbsp; </p>
                  <div align="center">
                  	<button class="btn btn"><a href="eis_admin_manage_dept.php">CANCEL</a></button>&nbsp;
