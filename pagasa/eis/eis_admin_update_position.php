      ...
      <div class="widget stacked widget-table action-table">
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-user"></i>Editing/Updating Position</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
			...
			$find_pos=mysql_query("SELECT * FROM employee_position_t WHERE position_id='$id'");
			while($found_pos=mysql_fetch_assoc($find_pos)){
			
			 ?>
          	<form action="actions/eis_edit_pos_action.php" method="post"> 
            <input type="hidden" name="pos_id" value="<?php echo $id; ?>">
            <table width="70%">
			  <tr>
			    <td>Position Title</td>
			    <td><input type="text" name="pos_title" value="<?php echo $found_pos['position_title']; ?>"></td>
			  </tr>
			  <tr>
			    <td>Position Type</td>
			    <td><select type="text" name="pos_type" >
                <option value="<?php echo $found_pos['position_type']; ?>"><?php echo $found_pos['position_type']; ?></option>
