...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<form action="eis_admin_manage_employees.php" method="post" class="mini">
				<table>
				<tr>
				<td>Search by:</td>
				<td>
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
           ...
           <ul class="nav nav-tabs">
					  <li class="active"><a href="#all" data-toggle="tab"><i class="icon-bookmark"></i> All</a></li>
					  <li><a href="#male" data-toggle="tab"><i class=" icon-user"></i> Male</a></li>
                      <li><a href="#female" data-toggle="tab"><i class="icon-user"></i> Female</a></li>
                      <li><a href="#teaching" data-toggle="tab"><i class=" icon-table"></i> Teaching</a></li>
					  <li><a href="#non_teaching" data-toggle="tab"><i class=" icon-envelope"></i>Non-Teaching</a></li>
                    </ul>
           ...
           <div id="demo" style="min-height:400px;">
            <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="font-size:14px">
						 ...
						 <?php
							include('../db/db.php');
							 $show_personnel="SELECT * FROM employee_t";
							...
							while($found_pos=mysql_fetch_assoc($show_pos)){	 	  
								  ?>
							<tr>
                            	<td class="center"><?php echo $found['emp_id']; ?>
                                </td>
								<td class="center"><a href="eis_admin_view_emp.php?emp_id=<?php echo $found['emp_id']; ?>" data-gravity=n title="View Profile" data-toggle="modal"><?php echo $found['f_name'].'&nbsp;'.$found['l_name'].'&nbsp;'.$found['name_extension']; ?></a></td>
								<td class="center"><?php echo $found['gender']; ?></td>
								<td class="center"><?php echo $found_pos['position_title']; ?></td>	
								<td class="center"><?php echo $found_pos['position_type']; ?></td>
						...
						<br/>
						<a class="btn " onClick="window.open('print_all_employees.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1000, height=900,position=center');"><span><i class="icon-print"></i></span>&nbsp;Print All Employees</a></td>
          		</div>
                </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="font-size:14px">
						...
						<br/>
						<a class="btn" onClick="window.open('print_male_list.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1000, height=900,position=center');"><span><i class="icon-print"></i></span>&nbsp;Print Male Employees</a></td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="font-size:14px">
						 ...
						 <?php
							include('../db/db.php');
							 $show_personnel="SELECT * FROM employee_t WHERE gender='Female'";
							 $show_p=mysql_query($show_personnel);
							 while($found=mysql_fetch_assoc($show_p)){					
							 $id=$found['emp_id'];
							 $show_role=mysql_query("SELECT * FROM employee_role_t WHERE emp_id='$id'");
						...
						<br/>
						<a class="btn " onClick="window.open('print_female_list.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1000, height=900,position=center');"><span><i class="icon-print"></i></span>&nbsp;Print Female Employees</a></td>
                </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="font-size:14px">
						 ...
						 <?php
							...
							$show_pos=mysql_query("SELECT * from employee_position_t WHERE position_type='teaching' AND position_id='$role_id'");
						...
						<br/>
						<a class="btn " onClick="window.open('print_teaching_list.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1000, height=900,position=center');"><span><i class="icon-print"></i></span>&nbsp;Print Teaching Employees</a>
                </div>
                
                
                
				<div class="tab-pane" id="non_teaching">
                <table cellpadding="0" cellspacing="0" border="0" class=" " id="example" width="100%" style="font-size:14px">
							<thead>
								<tr>
                                <th>Emp ID</th>
						 ...
						 <?php
							...
							$show_pos=mysql_query("SELECT * from employee_position_t WHERE position_type='non-teaching' AND position_id='$role_id'");
						...
						<br/>
						<a class="btn " onClick="window.open('print_non_teaching_list.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1000, height=900,position=center');"><span><i class="icon-print"></i></span>&nbsp;Print Non-Teaching Employees</a></td>
                </div> 
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a   class="btn btn-block" onClick="window.open('add2.php','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=850, height=900,position=center');"><span><i class="icon-plus"></i></span>Add New Personnel</a>
				...
				<a class="btn btn-block" href="eis_admin_manage_position.php"><span><i class=" icon-briefcase"></i></span>Manage Positions</a>
                </th>
              </tr>
            </tbody>
          </table>
  ...
  <div class="modal-body">
    ...
    <form action="actions/add_pos.php" method="post">
		<table class=" ">
			...
			<tr>
				<td colspan="2">&nbsp;</td>
				<td colspan="2" align="center"><input type="submit" name="add_pos" value="Add"></td>
