...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    ...
    <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><span><i class="icon-credit-card"></i></span>&nbsp;Editing Leave Credits</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
          ...
          <?php 
		  	include("../db/db.php");
		  		if(isset($_GET['cat_id'])){
					$id=$_GET['cat_id'];
					$find_cat=mysql_query("SELECT * FROM  `eis_leave_add_cat` WHERE cat_id='$id'");
					while($found_cat=mysql_fetch_assoc($find_cat)){		
		  
		  ?>
          	<form action="actions/eis_update_credits_action.php" method="post"> 
            <input type="hidden" name="cat_id" value="<?php echo $id; ?>">
            <table width="70%">
			  <tr>
			    <td>POSITION TYPE</td>
			    <td><?php echo strtoupper($found_cat['position_type']); ?></td>
			  </tr>
			  <tr>
			    <td>SICK CREDIT(S)</td>
			    <td><input type="text" name="sick_cred" value="<?php echo $found_cat['sick_credits']; ?>"></td>
			  </tr>
			  <tr>
			    <td>VACATION CREDIT(S)</td>
			    <td><input type="text" name="vac_cred" value="<?php echo $found_cat['vac_credits']; ?>"></td>
			  </tr>
			  <tr>
			    <td colspan="2"><p>&nbsp; </p>
                  <div align="left">
                  	<a href="eis_admin_manage_credits.php" class="btn btn-tertiary">CANCEL</a>&nbsp;
