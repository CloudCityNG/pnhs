...
?>   
      <div class="widget-content">
            ...
            <thead>
              <tr>
                <th width="80%"><i class="icon-group"></i> EDIT DEPARTMENT</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
          ...
          <div id="demo" style="min-height:400px;">
          	...
          	<h4>EDIT <?php echo strtoupper($row['dept_name']); ?></h4>
          	<p>&nbsp;</p>
          	<form action="actions/eis_edit_dept_action.php" method="post"> 
            <input type="hidden" name="dept_id" value="<?php echo $dept_id; ?>">
            <table width="70%">
			  <tr>
			    <td>Department Name</td>
			    <td><input type="text" name="dept_name" value="<?php echo strtoupper($row['dept_name']); ?>"></td>
			  </tr>
			  <tr>
			    <td>Department Description</td>
			    <td><input type="text" name="dept_description" value="<?php echo ucfirst($row['dept_description']); ?>"></td>
			  </tr>
			  <tr>
                ...
                <select name="dept_head">
		  				...
		  				include('../db/db.php');
							...
							$sql = mysql_query("SELECT * FROM department_t, employee WHERE dept_id = '$dept_id'");
							while($row1 = mysql_fetch_array($sql)){
							echo "<option value='".$row1['dept_head']."' selected='selected'>".ucfirst($row1['f_name'])." ".ucfirst($row1['m_name'])." ".ucfirst($row1['l_name'])."</option>"; }
							echo "<option value='0' >-- N/A -- </option>";
							
							$head = mysql_query("SELECT * FROM employee_t WHERE dept_id = '$dept_id'");
			  ...
			  <tr>
			    <td colspan="2"><p>&nbsp; </p>
                  <div align="left">
                  	<a href="eis_admin_manage_dept.php" class="btn btn-tertiary">CANCEL</a>&nbsp;
