        ...
        <div class="widget-content">
		  ...
		  <div class="header"> <h3><?php echo strtoupper($lname).", ".ucfirst($fname)." ".ucfirst($m_name); ?> Leave Request</h> </div>
                ...
                <div align="center">
                  ...
                  <form action="actions/disapprove_leave.php?leave_id=<?php echo $leave_id; ?>" method="post">
                  	<input type="hidden" name="leave_id" value="<?php echo $leave_id; ?>"><br>
                  	<textarea name="response" rows="10" cols="30" placeholder="REASON..."></textarea>
                  	<br>
