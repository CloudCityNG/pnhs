...
d1.setHours(0,0,0,1);  // Start just after midnight
d2.setHours(23,59,59,999);  // End just before midnight
var diff = d2 - d1;  // Milliseconds between datetime objects    
...
<?php
include ("../db/db.php");
$sql = mysql_query("SELECT * FROM holidays_t");
	...
	if(select.value == ''){
     ...
     <div id="vleave_reason" style="display:none;">
      ...
      <div id="sleave_reason" style="display:none;">
        <input type="radio" name="sleave_reason" id="sleave_reason1"  onClick="reason(id)"  value="Maternity" class="validate[required] radio"/>Maternity<br />
...
Not Requested</td>
  ...
  <tr>
	...
	?>  
	<td style="border:3px #dce9f9 solid;border-left:none;"><input type="text" name="duration" id="duration" size="10" readonly placeholder="calculate" style="text-align:center;" class="validate[custom[num],min[1],max[30]]"/>
      Day(s) </td>
	<?php } ?>
    <td >&nbsp;</td>
    <td>&nbsp;</td>
