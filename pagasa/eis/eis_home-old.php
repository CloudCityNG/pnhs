<?php 
 ...
 echo "<meta http-equiv=\"refresh\" content=\"0;URL=../?error=Login_Required\">";
	...
	$find_acc=mysql_query("SELECT * FROM acccount_t WHERE username='$username'");
	while($found_acc=mysql_fetch_assoc($find_acc)){
	$acc_no=$found_acc['account_no'];
	
		$find_per=mysql_query("SELECT * FROM account_permission_t WHERE account_no='$acc_no'");
		while($found_per=mysql_fetch_assoc($find_per)){
			$priv_id=$found_per['privilege_id'];
		
			if($priv_id=='1' && $priv_id=='2' && $priv_id=='3'){
				header("location: eis_admin_dashboard.php");
			}
			else if($priv_id=='17'){
	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			<div class="subnav-collapse collapse">
			  <ul class="mainnav">
			    <li class="active"> <a href="file:///C|/xampp/htdocs/eis/eis_home.php"> <i class="icon-home"></i> <span>EIS Home</span></a></li>
			   </ul>
		    </div>
			<!-- InstanceEndEditable -->
	...
	<!-- InstanceBeginEditable name="main" -->
      <div class="widget stacked">
        ...
        <div class="widget-content">
          <div id="demo">
            <p><a class="btn" href="eis_admin_dashboard.php">Admin<a></p>
            <p>&nbsp;</p>
            <p><a class="btn" href="eis_emp_home.php">Employee<a></p>
          </div>
          <br/>
