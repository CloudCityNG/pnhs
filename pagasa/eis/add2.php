...
<!-- For Adding Educational Background -->

<script language="javascript">

Elemrow_no=2;	
//elem_row=Elemrow_no+3;
function addRowElem(tbl,row){
//row count

var tick = String(Elemrow_no);
if (Elemrow_no<6){
//Declaring text boxes
var count ='<td>' + tick + '&nbsp;<a class="button small red" value="Delete" onclick="deleteRowElem(this)" style="width:60px;height:15px;" ><span class="i16-icon_alert"></span>Delete</a></td>';
var textbox  =' <td><div align="center"><input type="text" name="elem_school_name'+tick+'" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/></div></td>';
var textbox2 = ' <td><div align="center"><input type="text" name="elem_degree'+tick+'" style="width:90px;height:20px"/></div></td>';
var textbox3 = '<td><div align="center"><input type="text" name="elem_year_grad'+tick+'"  id="emp_year_grad_elem'+tick+'"  style="width:50px;height:20px;"/></div></td>';
var textbox4 = '<td><div align="center"><input type="text" name="elem_highest_grade'+tick+'" style="width:80px;height:20px;"/></div></td>';
var textbox5 = '<td><div align="center"><input type="date" name="elem_attendance_from'+tick+'" id="emp_elem_attendance_from'+tick+'"  style="width:90px;height:20px;"/></div></td>';
var textbox6 = ' <td><div align="center"><input type="date" name="elem_attendance_to'+tick+'" id="emp_elem_attendance_to'+tick+'"  style="width:90px;height:20px;"/></div></td>';
var textbox7 = '<td><div align="center"><input type="text" name="elem_scholarship'+tick+'" style="width:80px;height:20px;"/></div></td>';
//delete button
var stop = '<button value="Delete" onclick="deleteRowElem(this)" style="width:10px;height:10px;color:#F00;" />';
...
var newRow = tbl.insertRow(elem_row);
...
//Delete Function
function deleteRowElem(r)
{
    var i=r.parentNode.parentNode.rowIndex;
    document.getElementById('ElemTable').deleteRow(i);
...
function addRowSecon(tbl,row){
//row count

var Stick = String(Seconrow_no);
if (Seconrow_no<6){
//Declaring text boxes
var Scount ='<td>' + Stick + '&nbsp;<a class="button small red" value="Delete" onclick="deleteRowSecon(this)" style="width:60px;height:15px;" ><span class="i16-icon_alert"></span>Delete</a></td>';
var Stextbox  =' <td><div  align="center"><input type="text" name="second_school_name'+Stick+'" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/></div></td>';
var Stextbox2 = ' <td><div align="center"><input type="text" name="second_degree'+Stick+'" style="width:90px;height:20px"/></div></td>';
var Stextbox3 = '<td><div align="center"><input type="text" name="second_year_grad'+Stick+'"  id="emp_year_grad_second'+Stick+'"  style="width:50px;height:20px;"/></div></td>';
var Stextbox4 = '<td><div align="center"><input type="text" name="second_highest_grade'+Stick+'" style="width:80px;height:20px;"/></div></td>';
var Stextbox5 = '<td><div align="center"><input type="date" name="second_attendance_from'+Stick+'" id="emp_second_attendance_from'+Stick+'"  style="width:90px;height:20px;"/></div></td>';
var Stextbox6 = ' <td><div align="center"><input type="date" name="second_attendance_to'+Stick+'" id="emp_second_attendance_to'+Stick+'"  style="width:90px;height:20px;"/></div></td>';
var Stextbox7 = '<td><div align="center"><input type="text" name="second_scholarship'+Stick+'" style="width:80px;height:20px;"/></div></td>';
//delete button
var stop = '<button value="Delete" onclick="deleteRowElem(this)" style="width:10px;height:10px;color:#F00;" />';

if(Elemrow_no==2){
secon_row=Seconrow_no+5;
}else if(Elemrow_no==3){
secon_row=Seconrow_no+6;
}else if(Elemrow_no==4){
secon_row=Seconrow_no+7;
}else if(Elemrow_no==6){
secon_row=Seconrow_no+8;
}
...
var tbl = document.getElementById(tbl);
var rowIndex = document.getElementById(row).value;
var newRow = tbl.insertRow(secon_row);
var newCell = newRow.insertCell(0);
newCell.innerHTML = Scount;
var newCell = newRow.insertCell(1);
newCell.innerHTML = Stextbox;
var newCell = newRow.insertCell(2);
newCell.innerHTML = Stextbox2;
var newCell = newRow.insertCell(3);
newCell.innerHTML = Stextbox3;
var newCell = newRow.insertCell(4);
newCell.innerHTML = Stextbox4;
var newCell = newRow.insertCell(5);
newCell.innerHTML = Stextbox5;
var newCell = newRow.insertCell(6);
newCell.innerHTML = Stextbox6;
var newCell = newRow.insertCell(7);
newCell.innerHTML = Stextbox7;
//delete button within cell
//var newCell = newRow.insertCell(8);
//newCell.innerHTML = stop;
...
function addRowVoc(tbl,row){
//row count

var Vtick = String(Vocrow_no);
if (Vocrow_no<6){
//Declaring text boxes
var Vcount ='<td>' + Vtick + '&nbsp;<a class="button small red" value="Delete" onclick="deleteRowVoc(this)" style="width:60px;height:15px;" ><span class="i16-icon_alert"></span>Delete</a></td>';
var Vtextbox  =' <td><div  align="center"><input type="text"  name="voc_school_name'+Vtick+'" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/></div></td>';
var Vtextbox2 = ' <td><div align="center"><input type="text" name="voc_degree'+Vtick+'" style="width:90px;height:20px"/></div></td>';
var Vtextbox3 = '<td><div align="center"><input type="text" name="voc_year_grad'+Vtick+'"  id="emp_year_grad_voc'+Vtick+'"  style="width:50px;height:20px;"/></div></td>';
var Vtextbox4 = '<td><div align="center"><input type="text" name="voc_highest_grade'+Vtick+'" style="width:80px;height:20px;"/></div></td>';
var Vtextbox5 = '<td><div align="center"><input type="date" name="voc_attendance_from'+Vtick+'" id="emp_voc_attendance_from'+Vtick+'"  style="width:90px;height:20px;"/></div></td>';
var Vtextbox6 = ' <td><div align="center"><input type="date" name="voc_attendance_to'+Vtick+'" id="emp_voc_attendance_to'+Vtick+'"  style="width:90px;height:20px;"/></div></td>';
var Vtextbox7 = '<td><div align="center"><input type="text" name="voc_scholarship'+Vtick+'" style="width:80px;height:20px;"/></div></td>';
//delete button
var stop = '<button value="Delete" onclick="deleteRowElem(this)" style="width:10px;height:10px;color:#F00;" />';
...
var tbl = document.getElementById(tbl);
var rowIndex = document.getElementById(row).value;
var newRow = tbl.insertRow(voc_row);
var newCell = newRow.insertCell(0);
newCell.innerHTML = Vcount;
var newCell = newRow.insertCell(1);
newCell.innerHTML = Vtextbox;
var newCell = newRow.insertCell(2);
newCell.innerHTML = Vtextbox2;
var newCell = newRow.insertCell(3);
newCell.innerHTML = Vtextbox3;
var newCell = newRow.insertCell(4);
newCell.innerHTML = Vtextbox4;
var newCell = newRow.insertCell(5);
newCell.innerHTML = Vtextbox5;
var newCell = newRow.insertCell(6);
newCell.innerHTML = Vtextbox6;
var newCell = newRow.insertCell(7);
newCell.innerHTML = Vtextbox7;
//delete button within cell
//var newCell = newRow.insertCell(8);
//newCell.innerHTML = stop;
...
function addRowCol(tbl,row){
//row count

var Ctick = String(Colrow_no);
if (Colrow_no<6){
//Declaring text boxes
var Ccount ='<td>' + Ctick + '&nbsp;<a class="button small red" value="Delete" onclick="deleteRowCol(this)" style="width:60px;height:15px;" ><span class="i16-icon_alert"></span>Delete</a></td>';
var Ctextbox  =' <td><div  align="center"><input type="text"  name="col1_school_name'+Ctick+'" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/></div></td>';
var Ctextbox2 = ' <td><div align="center"><input type="text" name="col1_degree'+Ctick+'" style="width:90px;height:20px"/></div></td>';
var Ctextbox3 = '<td><div align="center"><input type="text" name="col1_year_grad'+Ctick+'"  id="emp_year_grad_col1'+Ctick+'"  style="width:50px;height:20px;"/></div></td>';
var Ctextbox4 = '<td><div align="center"><input type="text" name="col1_highest_grade'+Ctick+'" style="width:80px;height:20px;"/></div></td>';
var Ctextbox5 = '<td><div align="center"><input type="date" name="col1_attendance_from'+Ctick+'" id="emp_col1_attendance_from'+Ctick+'"  style="width:90px;height:20px;"/></div></td>';
var Ctextbox6 = ' <td><div align="center"><input type="date" name="col1_attendance_to'+Ctick+'" id="emp_col1_attendance_to'+Ctick+'"  style="width:90px;height:20px;"/></div></td>';
var Ctextbox7 = '<td><div align="center"><input type="text" name="col1_scholarship'+Ctick+'" style="width:80px;height:20px;"/></div></td>';
//delete button
var stop = '<button value="Delete" onclick="deleteRowElem(this)" style="width:10px;height:10px;color:#F00;" />';

//col_row=Colrow_no+10;

if(Elemrow_no==2){
col_row=Colrow_no+10;
}else if(Elemrow_no==3){
col_row=Colrow_no+11;
}else if(Elemrow_no==4){
col_row=Colrow_no+12;
}else if(Elemrow_no==6){
col_row=Colrow_no+13;
}

//Inserting textboxes into table cells
var tbl = document.getElementById(tbl);
var rowIndex = document.getElementById(row).value;
var newRow = tbl.insertRow(col_row);
var newCell = newRow.insertCell(0);
newCell.innerHTML = Ccount;
var newCell = newRow.insertCell(1);
newCell.innerHTML = Ctextbox;
var newCell = newRow.insertCell(2);
newCell.innerHTML = Ctextbox2;
var newCell = newRow.insertCell(3);
newCell.innerHTML = Ctextbox3;
var newCell = newRow.insertCell(4);
newCell.innerHTML = Ctextbox4;
var newCell = newRow.insertCell(5);
newCell.innerHTML = Ctextbox5;
var newCell = newRow.insertCell(6);
newCell.innerHTML = Ctextbox6;
var newCell = newRow.insertCell(7);
newCell.innerHTML = Ctextbox7;
//delete button within cell
//var newCell = newRow.insertCell(8);
//newCell.innerHTML = stop;
...
function addRowGrad(tbl,row){
//row count

var Gtick = String(Gradrow_no);
if (Gradrow_no<6){
//Declaring text boxes
var Gcount ='<td>' + Gtick + '&nbsp;<a class="button small red" value="Delete" onclick="deleteRowGrad(this)"  style="width:60px;height:15px;" ><span class="i16-icon_alert"></span>Delete</a></td>';
var Gtextbox  =' <td><div  align="center"><input type="text"  name="grad1_school_name'+Gtick+'" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/></div></td>';
var Gtextbox2 = ' <td><div align="center"><input type="text" name="grad1_degree'+Gtick+'" style="width:90px;height:20px"/></div></td>';
var Gtextbox3 = '<td><div align="center"><input type="text" name="grad1_year_grad'+Gtick+'"  id="emp_year_grad_grad1'+Gtick+'"  style="width:50px;height:20px;"/></div></td>';
var Gtextbox4 = '<td><div align="center"><input type="text" name="grad1_highest_grade'+Gtick+'" style="width:80px;height:20px;"/></div></td>';
var Gtextbox5 = '<td><div align="center"><input type="date" name="grad1_attendance_from'+Gtick+'" id="emp_grad1_attendance_from'+Gtick+'"  style="width:90px;height:20px;"/></div></td>';
var Gtextbox6 = ' <td><div align="center"><input type="date" name="grad1_attendance_to'+Gtick+'" id="emp_grad1_attendance_to'+Gtick+'"  style="width:90px;height:20px;"/></div></td>';
var Gtextbox7 = '<td><div align="center"><input type="text" name="grad1_scholarship'+Gtick+'" style="width:80px;height:20px;"/></div></td>';
//delete button
var stop = '<button value="Delete" onclick="deleteRowElem(this)" style="width:10px;height:10px;color:#F00;" />';

//grad_row=Gradrow_no+13;

if(Elemrow_no==2){
grad_row=Gradrow_no+13;
}else if(Elemrow_no==3){
grad_row=Gradrow_no+14;
}else if(Elemrow_no==4){
grad_row=Gradrow_no+15;
}else if(Elemrow_no==6){
grad_row=Gradrow_no+16;
}

//Inserting textboxes into table cells
var tbl = document.getElementById(tbl);
var rowIndex = document.getElementById(row).value;
var newRow = tbl.insertRow(grad_row);
var newCell = newRow.insertCell(0);
newCell.innerHTML = Gcount;
var newCell = newRow.insertCell(1);
newCell.innerHTML = Gtextbox;
var newCell = newRow.insertCell(2);
newCell.innerHTML = Gtextbox2;
var newCell = newRow.insertCell(3);
newCell.innerHTML = Gtextbox3;
var newCell = newRow.insertCell(4);
newCell.innerHTML = Gtextbox4;
var newCell = newRow.insertCell(5);
newCell.innerHTML = Gtextbox5;
var newCell = newRow.insertCell(6);
newCell.innerHTML = Gtextbox6;
var newCell = newRow.insertCell(7);
newCell.innerHTML = Gtextbox7;
//delete button within cell
//var newCell = newRow.insertCell(8);
//newCell.innerHTML = stop;
...
<table class="table" width="816" >
                          ...
                          <td colspan="2"><input text-input type="text" name="emp_id" id="emp_id" style="width:200px;height:20px;" class="validate[required,ajax[myTryCallHehe],custom[onlyLetterNumber]] "  /></td>
                          <td colspan="2" style="background-color:#EAEAEA;">DEPARTMENT</td>
							<td width="109"> <select name="dept" id="dept" class="validate[required]" style="height:25px;font-size:12px;width:auto" >
						  ...
						  <tr>
							...
							<td colspan="2" style="background-color:#EAEAEA;">POSITION</td>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="zipcode1" id="p_zip1"   style="width:200px;height:20px;" class="validate[required],custom[num],minSize[4],maxSize[4]"/></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							...
							<td colspan="2" style="background-color:#EAEAEA;">ZIP</td>
							<td colspan="2"><input type="text" name="zipcode2"id="zipcode2"  style="width:200px;height:20px;" class="validate[custom[num]],minSize[4],maxSize[4]"/></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="weight" id="weight"  style="width:200px;height:20px;" class="validate[required] text-input,custom[number]"/></td>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="bloodtype"  id="bloodtype" style="width:200px;height:20px;" class="validate[required] text-input,custom[onlyLetterSp]"/></td>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="gsis_id_no"  id="gsis_id_no" style="width:200px;height:20px;" class="validate[required],custom[num],minSize[11],maxSize[11]"/></td>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="pagibig_id_no" id="pagibig_id_no" style="width:200px;height:20px;" class="validate[required],custom[num],minSize[12],maxSize[12]"/></td>
						  ...
						  <tr>
							...
							<td colspan="2"><input type="text" name="philhealth_no" id="philhealth_no" style="width:200px;height:20px;" class="validate[required],custom[num],minSize[12],maxSize[12]"/></td>
							<td colspan="4" rowspan="2" style="display:none;">&nbsp;</td>
						  </tr>
						  <tr>
							<td colspan="2" style="background-color:#EAEAEA;">SSS NO.</td>
							<td colspan="2"><input type="text" name="sss_no"  id="sss_no" style="width:200px;height:20px;" class="validate[required],custom[num],minSize[11],maxSize[11]"/></td>
						  </tr>
						  <tr>
...
<table width="816" class="table">
                          ...
                          <table class="table" width="816" id="ElemTable">
						  <tr>
						  ...
						  <tr>
							<td colspan="1" style="background-color:#EAEAEA;"><div align="center">From</div></td>
							<td colspan="1" style="background-color:#EAEAEA;"><div align="center">To</div></td>
						  </tr>
						 ...
						 <tr>
                            ...
                            <td width="100" style="background-color:#EAEAEA;">ELEMENTARY<a class="button small grey" name="ElemButton" value="Add More" onClick="addRowElem('ElemTable','ERow1')"><span class=" i16-icon_create---write"></span>Add More</a></td>
                            
							
                           
							<td width="120"> <div align="center">
							  <input type="text" name="elem_school_name1" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/>
							</div></td>
							<td width="130">    <div align="center">
							  <input type="text" name="elem_degree1" style="width:90px;height:20px"/>
							</div></td>
							<td width="66"> 							  <div align="center">
							  <input type="text" name="elem_year_grad1"  id="emp_year_grad_elem"  style="width:50px;height:20px;"/>
							</div></td>
							<td>  <div align="center">
							  <input type="text" name="elem_highest_grade1" style="width:80px;height:20px;"/>
							</div></td>
							<td>  <div align="center">
							  <input type="date" name="elem_attendance_from1" id="emp_elem_attendance_from"  style="width:90px;height:20px;"/>
							</div></td>
							<td>  <div align="center">
							  <input type="date" name="elem_attendance_to1" id="emp_elem_attendance_to"  style="width:90px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="elem_scholarship1" style="width:80px;height:20px;"/>
							</div></td>
							...
							<td>
								<table id="ElemTable">
									<tr>
										<td><a class="button button-success" name="ElemButton" value="Add More" onClick="addRowElem('ElemTable','ERow1')">Add More</a></td>
									</tr>
									<tr id="ERow1">
									</tr>
								</table>
                          ...
                          <tr>
							<td style="background-color:#EAEAEA;">SECONDARY<a class="button small grey" name="SeconButton" value="Add More" onClick="addRowSecon('ElemTable','ERow2')"><span class=" i16-icon_create---write"></span>Add More</a></td>
							<td> <div align="center">
							  <input type="text" name="second_school_name1" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="second_degree1" style="width:90px;height:20px"/>
							</div></td>
							<td> <div align="center">
							  <input type="text"  name="second_year_grad1" id="emp_year_grad_second"  style="width:50px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text"name="second_highest_grade1" style="width:80px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="date"   name="second_attendance_from1" id="emp_second_attendance_from"  style="width:90px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="date" name="second_attendance_to1" id="emp_second_attendance_to"  style="width:90px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="second_scholarship1" style="width:80px;height:20px;"/>
							</div></td>
						  </tr>
						...
						TRADE COURSE</span><a class="button small grey" name="VocButton" value="Add More" onClick="addRowVoc('ElemTable','ERow3')"><span class=" i16-icon_create---write"></span>Add More</a></td>
							<td>  <div align="center">
							  <input type="text" name="voc_school_name1" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="voc_degree1" style="width:90px;height:20px"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="voc_year_grad1" id="emp_year_grad_voc"  style="width:50px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="voc_highest_grade1" style="width:80px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="date" name="voc_attendance_from1" id="emp_voc_attendance_from"  style="width:90px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="date" name="voc_attendance_to1" id="emp_voc_attendance_to"  style="width:90px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="voc_scholarship1" style="width:80px;height:20px;"/>
							</div></td>
						  </tr>
						  ...
						  <tr>
							<td rowspan="2" style="background-color:#EAEAEA;">COLLEGE<a class="button small grey" name="ColButton" value="Add More" onClick="addRowCol('ElemTable','ERow4')"><span class=" i16-icon_create---write"></span>Add More</a></td>
							<td>  <div align="center">
							  <input type="text" name="col1_school_name1" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="col1_degree1" style="width:90px;height:20px"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="col1_year_grad1" id="emp_year_grad_col1"  style="width:50px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="col1_highest_grade1" style="width:80px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="date" name="col1_attendance_from1" id="emp_col1_attendance_from"  style="width:90px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="date" name="col1_attendance_to1" id="emp_col1_attendance_to"   style="width:90px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="col1_scholarship1" style="width:80px;height:20px;"/>
							</div></td>
						  </tr>
						...
						<!--  <tr>
						  ...
						  <tr>
							<td rowspan="2" style="background-color:#EAEAEA;">GRADUATE STUDIES<a class="button small grey" name="GradButton" value="Add More" onClick="addRowGrad('ElemTable','ERow5')"><span class=" i16-icon_create---write"></span>Add More</a></td>
							<td> <div align="center">
							  <input type="text" name="grad1_school_name1" class="validate[custom[onlyLetterSp]]" style="width:120px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="grad1_degree1" style="width:90px;height:20px"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="grad1_year_grad1" id="emp_year_grad_grad1"  style="width:50px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="text" name="grad1_highest_grade1" style="width:80px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="date" name="grad1_attendance_from1" id="emp_grad1_attendance_from"  style="width:90px;height:20px;"/>
							</div></td>
							<td> <div align="center">
							  <input type="date" name="grad1_attendance_to1" id="emp_grad1_attendance_to"  style="width:90px;height:20px;"/>
							</div></td>
							<td><div align="center">
							  <input type="text" name="grad1_scholarship1" style="width:80px;height:20px;"/>
							</div></td>
						  </tr>
							 ...
							 <table class="table" width="816">
							  ...
							  <tr>
								...
								<td rowspan="2" style="background-color:#EAEAEA;"><div align="center">DATE OF<BR />
								  EXAMINATION/<BR />
								CONFERMENT<br />(yyyy/mm/dd)</div></td>
							  ...
							  <tr>
								...
								<td width="105" style="background-color:#EAEAEA;"><div align="center">DATE OF RELEASE<br />(yyyy/mm/dd)</div></td>
							  </tr>
								<?php  for($x = 1;$x<=8;$x++){ ?>
							  <tr>
