	...
	<!-- InstanceBeginEditable name="main" -->
        <div class="widget-content">
            ...
            <tbody>
              <tr >
                <th >
                <p><h3>&nbsp;<?php echo strtoupper($res['dept_name'])." "."DEPARTMENT"; ?></h3></p>
                <p><h4>&nbsp;REQUEST LIST</h4></p>
                 ...
                 <?php 
					...
					$query = mysql_query("SELECT *
                        ...
                        <tr class="del<?php echo $id ?>">
                            <td align="center" width="70"><?php echo $row['date_recieved']; ?></td>
                            <td><?php echo ucfirst($row['l_name']).", ".ucfirst($row['f_name'])." ".ucfirst($row['m_name']); ?></td>
                            ...
                            <td bgcolor="#ECEEFF" width="150" align="center">
								<a title="CONTINUE REQUEST" class="btn-mini btn-success" href="JavaScript:if(confirm('Are you sure you want to continue this request?')==true)
							{window.location='actions/inv_confirm_request_action.php?sd_id=<?php echo $row["sd_id"];?>';}"><i class="icon-check"></i> CONFIRM</a>
                                <a title="CANCEL THE REQUEST" class="btn-mini btn-danger" href="JavaScript:if(confirm('Are you sure you want to delete this request?')==true)
							{window.location='actions/inv_cancel_request_action.php?sd_id=<?php echo $row["sd_id"];?>';}"><i class="icon-remove"></i> CANCEL</a>
                            </td>
                        </tr>
                  <?php }?>
                </tbody>
