...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
   ...
   <h1 align="center">Updating Member</h1>
    <br/>
    ...
    <table align="center" class="alert alert-success">
    <tr>
    <td>Club ID/Name:</td>
    ...
    <td><input type="text" name="year" value="<?php echo $row['academicyear_joined'] ?>"></td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    <td> <input type="submit" value="Update" name="update_mem" class="btn btn-info">&nbsp;&nbsp;<a class="btn btn-danger" onclick="window.history.back()">Cancel</a></td>
    </tr>
    </table>
