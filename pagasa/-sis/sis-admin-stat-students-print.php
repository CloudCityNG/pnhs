...
<?php   
		  ...
		  if(isset($_GET['sy'])){
			  ...
			  $sy2 = $getsy['sy_end'];
               ...
               <h4 align="center">LIST OF STUDENTS WITH RECORDED OFFENSE IN SCHOOL YEAR <?php echo $sy1 ?>-<?php echo $sy2 ?></h4>
          ...
          <?php
			  ...
			  $number = mysql_num_rows($queryslist);
			  	if($number){
		  ...
		  ?>
				...
				else
				{
					?>
                     ...
                     <center>No data recorded.</center>  
...
<br />
<br />
<h5>TOTAL STUDENTS WITH OFFENSES - <?php echo $number ?></h5>
