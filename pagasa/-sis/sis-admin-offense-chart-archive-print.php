...
<input name="print" type="button" value="Print" id="printButton" onClick="printpage()">
  ...
  <div id="container" align="center">
	  ...
	  <?php 		include("../db/db.php");
			                ...
			                $toshow = $_GET['school_year'];
							
					$querycurryear = mysql_query("SELECT * FROM school_year_t WHERE sy_id = '$toshow'");
...
<h4 align="center">FOR SCHOOL YEAR <?php echo $curryear1 ?>-<?php echo $curryear2 ?></h4>
<br />
<br />
	  ...
	  <div class="span6" style="width:300px">
      		...
      		<div class="widget stacked" style="width:300px" >
				...
				<div class="widget-header" style="width:300px" >
					<i class="icon-star"></i>
					<h3>Chart Representation</h3>
				</div> <!-- /widget-header -->
				
				<div class="widget-content" style="height:300px; height:500px"">
