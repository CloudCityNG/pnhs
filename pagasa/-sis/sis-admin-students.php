       ...
       <?php $query_sy=mysql_query("SELECT * FROM school_year_t WHERE SY_status=1");
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-list"></i>UNDERGRADUATE</th>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" dynamic styled with-prev-next" id="example" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="131">First Name</th>
                        <th width="89">Year Level</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                 ...
                 <?php 
					include('../db/db.php');
					$query=mysql_query("SELECT * FROM student_t WHERE student_type != 'alumni' ORDER BY l_name");
                    ...
                    <tr class="del<?php echo $id ?>">
                      ...
                      <td align="center" width="356">      
                        ...
                        <a class="btn btn-success" href="sis-admin-update-student.php?student_id=<?php echo $row['student_id'] ;?>">&nbsp;Details/Update</a> 
                        <a class="btn btn-secondary" href="sis-admin-view-memberships.php?student_id=<?php echo $row['student_id'] ;?>">&nbsp;Club/s</a>
                        <?php
						$sid = $row['student_id'];
                        ...
                        <a class="btn btn-tertiary"  onClick="window.open('../-scheduling/sched_section.php?section_id=<?php echo $sec?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=650,position=center')">&nbsp;Schedule</a>
                        <!-- <a class="btn btn-small btn-subnavbar"  onClick="window.open('../-sis/form137.php?student_id=<?php echo $sid?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=650,position=center')">&nbsp;Release Form 137</a> -->
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="sis-admin-alumni.php"><i class=" icon-pencil"></i> Alumni</a>
