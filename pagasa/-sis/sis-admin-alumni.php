       ...
       <?php $query_sy=mysql_query("SELECT * FROM school_year_t WHERE SY_status=1");
        ...
        <div class="widget-content" >
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="80%"><i class="icon-list"></i>ALUMNI</th>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class=" dynamic styled with-prev-next" id="example" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="166">First Name</th>
                        <th width="88">Year Level</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                 ...
                 <?php 
                    ...
                    <tr class="del<?php echo $id ?>">
                      <td  align="center" width="88"><?php echo $row['student_id']; ?></td>
                      ...
                      <td align="center" width="327">      
                        ...
                        <a class="btn btn-success" href="sis-admin-update-student.php?student_id=<?php echo $row['student_id'] ;?>">&nbsp;Details/Update</a> 
                         <!--<a class="btn btn-subnavbar"  onClick="window.open('../-sis/form137.php?student_id=<?php echo $sid?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=650,position=center')">&nbsp;Release Form 137</a> -->
                ...
                <th style="background-color:#F0F0F0">
                  ...
                  <a class="btn btn-block" href="sis-admin-students.php"><i class=" icon-pencil"></i> Undergraduate</a>
