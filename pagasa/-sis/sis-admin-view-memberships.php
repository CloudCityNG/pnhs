...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	$finddata = mysql_fetch_assoc($search2);
	  ...
	  ?>
    <h4>Club Memberships of <?php echo $finddata['f_name']."&nbsp;".$finddata['l_name']; ?></h4><br/>
                ...
                <tbody>
				 ...
				 require('../db/db.php');
                    ...
                    <tr class="del<?php echo $id ?>">
                      <td  align="center" width="100"><?php echo $row['club_id']; ?></td>
                      <td  align="center" width="100"><?php echo $row2['club_name']; ?></td>
                      <td  align="center" width="100"><?php 
														$position = $row['position']; 
														$querydef = mysql_query("SELECT * FROM club_position_t WHERE position_id = '$position'");
														$getdef = mysql_fetch_assoc($querydef);
														echo $getdef['position_desc'];
														?></td>
                      <td  align="center" width="100"><?php 
														$ay_joined = $row['academicyear_joined'];
														$queryyear = mysql_query("SELECT * FROM school_year_t WHERE sy_id = '$ay_joined'");
														$getyear = mysql_fetch_assoc($queryyear);
														echo $getyear['sy_start'].'-'.$getyear['sy_end'];
														?></td>
