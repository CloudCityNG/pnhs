...
<div class="span6" >
      		...
      		<div class="widget stacked" >
				...
				<div class="widget-content" style="height:1000px">
  				...
  				<div class="widget stacked widget-table"  style="height:1100px">
					...
					<div class="widget-content" style="width:450px; height:1050px">
						...
						<tbody><tr>
							...
							$count_name=0;
							$query_name=mysql_query("SELECT * from student_offense_list_t WHERE offense_code = '$offcode' AND school_year = '$toshow'");
...
<td align="center">
			 ...
			 <a onClick="window.open('../-sis/sis-admin-offense-chart-archive-print.php?school_year=<?php echo $toshow ?>','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=1100, height=650,position=center')" class="btn btn-large btn-default"><i class="icon-print"></i> Print</a>
...
$(function () {
		...
		$query_offense=mysql_query("SELECT * FROM discipline_offense_t");
			while($row_offense=mysql_fetch_assoc($query_offense)){
					...
					$count_off=0;
					$query_off=mysql_query("SELECT * from student_offense_list_t WHERE offense_code = '$off' AND school_year = '$toshow'");
