...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    ...
    <table>
    <tr>
    <td><h2>ACCEPT APPLICATION</h2></td>
    </tr>
    <tr>
 ...
 <tr align="left">
    <td ><a class="btn btn-success" href="accept_application(action).php?student_id=<?php echo $getstudid;?>&&club_id=<?php echo $clubid ?>&&club_app_id=<?php echo $club_app_id; ?>">Yes</a>&nbsp;<a class="btn btn-danger" onclick="window.history.back()">No</a></td>
    </tr>
    </table>
