	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			<!-- InstanceBeginEditable name="navbar" -->
			  <ul class="mainnav">
                <li class="active"> <a href="developer-home.php"> <i class="icon-calendar"></i> <span>Home</span> </a> </li>
	...
	<!-- InstanceBeginEditable name="content" -->
      ...
      <div class="widget stacked">
        ...
        <div class="widget-content">
          ...
          <tr>
          <td>
<button class="btn badge"><a href="sis-admin-home.php" style="text-decoration:none;">SIS Admin</a></button></td>
<td>
<button class="btn badge"><a href="student-home.php">Student</a></button>
</td>
<td>
<button class="btn badge"><a href="ca-home.php">Club Adviser</a></button>
</td>
</tr>
