...
require('../db/db.php');
 ...
 <tr>
  <td>
    ...
    <table>
    <tr>
    <td><a href="sis-actions/adv_reject_app.php?club_app_id=<?php echo $getreq['club_app_id']?>" class="btn btn-success">Yes</a></td>
    <td><a href="ca-club-applications.php" class="btn btn-tertiary">No</a></td>
    </tr>
    </table>
