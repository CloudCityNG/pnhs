...
require('../db/db.php'); 
 ...
 echo"<h2>CLUB APPLICATIONS</h2></br>";
 
 $queryapp2 = mysql_query("SELECT * FROM club_application_t WHERE club_id='$club_id'"); ?>
       ...
       <thead>
 <tr>
 <th><p>Student ID</font></p></th>
 <th><p>Student</font></p></th>
 <th><p>Application for</font></p></th>
 <th><p>Action</font></p></th>
 </tr>
 </thead>
 <tbody>
 <?php
 while($getapp = mysql_fetch_assoc($queryapp2)){ ?>

 <tr>
 
 <td align="center"><?php $studid = $getapp['student_id']; echo $studid;
?></td>

 <td align="center"><?php 
 $queryname = mysql_query("SELECT * FROM student_t WHERE student_id = '$studid'");
 $getname = mysql_fetch_assoc($queryname);
 echo $getname['l_name'].",&nbsp;".$getname['f_name']."&nbsp;".$getname['m_name'];
 ?></td>
 
 <td align="center"><?php echo $getapp['club_id'];?></td>
 <td align="center"><a class="btn btn-success" href="sis-admin-accept-application.php?club_app_id=<?php echo $getapp['club_app_id'];?>">Approve</a><a class="btn btn-danger" href="sis-admin-reject-application.php?club_app_id=<?php echo $getapp['club_app_id'];?>">Reject</a></td>
