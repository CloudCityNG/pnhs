...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
    ...
    <br>
 <h2>&nbsp;&nbsp;Add Members</h2>
 <form action="sis-admin-add-members.php" method="post">
 <table>
 <tr>
 <td>&nbsp;&nbsp;Student: </td>
 <td><select name="student-members">
 <option value="Abayon, Ralph Robert G.">Abayon, Ralph Robert G.</option>
 <option value="Alcera, John Jervie A.">Alcera, john Jervie A.</option>
 </select></td>
 </tr>
 <tr>
 <td>&nbsp;&nbsp;Position: </td>
 ...
 <tr>
 <td>&nbsp;&nbsp;Year joined: </td>
 <td><input name="year-joined" type="text"></td>
 </tr>
 <tr>
 <td>&nbsp;</td>
 <td align="right">
 <input type="submit" name="Add" value="Add" class="btn btn-success" />&nbsp;&nbsp;
 <a href='sis-admin-update-club?Edit=<?php echo $club_id;?>' class="btn btn-danger">Cancel</a></td>
 </tr>
 </table>
 </form>
                </div>
