...
require('../db/db.php');
    ...
    <table>
    <tr>
    <td><h2>REJECT APPLICATION</h2></td>
    </tr>
    <tr>
    <td>Are&nbsp;you&nbsp;sure&nbsp;you&nbsp;want&nbsp;to&nbsp;reject&nbsp;<?php  
 ...
 <tr>
    ...
    <td><a href="actions/reject_application.php?club_app_id=<?php echo $getreq['club_app_id']?>" class="btn btn-success">Yes</a>&nbsp;<a href="sis-admin-club-applications.php?Edit=<?php echo $getreq['club_id']?>" class="btn btn-danger">No</a></td>
    </tr>
    </table>
