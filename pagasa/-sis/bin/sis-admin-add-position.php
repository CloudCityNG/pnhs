	...
	<div class="subnavbar-inner" >
		...
		<div class="container" >
			...
			<!-- InstanceBeginEditable name="navbar" -->
			  <ul class="mainnav">
			    <li class="active"> <a href="sis-admin-add-position.php" > <i class="shortcut-icon icon-plus-sign"></i> <span class="shortcut-label">Add</span> </a> </li>
		      </ul>
	...
	<!-- InstanceBeginEditable name="content" -->
      ...
      <div class="widget stacked">
        ...
        <div class="widget-content">
                         <form style="text-align:center" action="sis-admin-add-position.php"  method="post"   enctype="multipart/form-data" id="validation-form">
						<table>
                        <tr>
                        <td>Position name:&nbsp;&nbsp;</td>
                        <td><input name="posname" /></td>
                        </tr>
						<Tr>
                        <td>&nbsp;</td><td>&nbsp;</td>
                        </Tr>
