...
<div class="main">
  ...
  <div class="container" style="width:1000px; margin-top:20px;">
	...
	<!-- InstanceBeginEditable name="content" -->
      ...
      <div class="widget stacked">
		...
		if(isset($_GET['student_id'])){
			...
			?>
    <h2>Add Offense\s to "<?php echo $get_stud['f_name']."&nbsp;".$get_stud['l_name'] ?>"</h2>
    ...
    <br>
    <table align="center">        
    <form action="sis-actions/add_offense.php?student_id=<?php echo $student_id ?>" method="post">
    <tr align="center"><td>Offenses:</td>
    <td>
    <select name="offense">
    ...
    <tr align="center">
    <td>&nbsp; </td>
    <td><input type="hidden" name="remarks" value="Uncleared"></td>
    </tr>
    <tr align="center">
    <td>Date</td>
    <td><input type="date" class="dateField" name="date"></td>
    </tr>
    <tr align="right">
    <td>&nbsp;</td>
    <td><input type="submit" name="Add" value="Add" class="btn btn-success" /> <a href="sis-admin-offenses.php" class="btn btn-tertiary">Cancel</a></td>
    </tr>
    </form>
